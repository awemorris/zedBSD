...
$(BUILD)/vmunix: $(BUILD)/stage2.elf $(BUILD_TOOLS_DIR)/patch-stage2.py
	cp $< $@
	$(PYTHON) $(BUILD_TOOLS_DIR)/patch-stage2.py $@
...
$(BUILD)/vmunix-m9: $(BUILD)/stage2-m9-test.elf $(BUILD_TOOLS_DIR)/patch-stage2.py
	cp $< $@
	$(PYTHON) $(BUILD_TOOLS_DIR)/patch-stage2.py $@
