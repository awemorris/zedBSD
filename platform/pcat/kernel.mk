...
ROOTFS_IMAGE_ARTIFACT := $(I386_ARCH_UFS_IMAGE)
...
DYNAMIC_SOFTFLOAT_OBJS := $(DYNAMIC_GCC_SOFTFLOAT_OBJS) \
...
$(BUILD)/zedbsd-grub.iso: $(BUILD)/vmunix \
	$(BUILD_TOOLS_DIR)/make-pcat-grub-iso.sh
	$(BUILD_TOOLS_DIR)/make-pcat-grub-iso.sh $@ $(BUILD)/vmunix
