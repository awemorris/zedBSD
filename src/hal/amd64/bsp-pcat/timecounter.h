...
enum amd64_tsc_frequency_policy_result amd64_timecounter_bsp_prepare(void);
uint64_t amd64_timecounter_sample_serialized(void);
void amd64_timecounter_pit_complete(uint64_t start, uint64_t end, uint64_t reference_hz, uint64_t reference_ticks);
