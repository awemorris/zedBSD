    ...
    int instruction,int write)
{
	...
	tte=sparcv9_tte(m->physical_address,flags);m->flags|=HAL_SPACE_PAGE_ACCESSED;if(m->attributes&HAL_SPACE_WRITE)m->flags|=HAL_SPACE_PAGE_DIRTY;
	slot=(page>>10)&0x1f8U;
