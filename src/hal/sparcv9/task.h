...
struct sparcv9_task{struct sparcv9_task*next;hal_space_t space;void*stack_allocation;void*stack;uintptr_t trap_sp;void*private_data;uintptr_t tls;uint64 trap_level,trap_pc,trap_next_pc,trap_state,trap_type;struct sparcv9_window_context windows,trap_windows;struct sparcv9_user_trap_frame*active_user_frame;uint64 active_pc,active_next_pc,active_tstate,active_trap_type;struct sparcv9_window_context signal_windows;struct sparcv9_user_trap_frame signal_frame;uint64 signal_pc,signal_next_pc,signal_tstate;uint32 signal_token,signal_depth;};
