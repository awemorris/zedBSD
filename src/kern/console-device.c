...
#define KEY_CAPABILITY(code) { EV_KEY, (code) }
static const struct input_capability keyboard_capabilities[] = {
	{EV_SYN, SYN_REPORT},
	KEY_CAPABILITY(KEY_A), KEY_CAPABILITY(KEY_B),
	KEY_CAPABILITY(KEY_C), KEY_CAPABILITY(KEY_D),
	KEY_CAPABILITY(KEY_E), KEY_CAPABILITY(KEY_F),
	KEY_CAPABILITY(KEY_G), KEY_CAPABILITY(KEY_H),
	KEY_CAPABILITY(KEY_I), KEY_CAPABILITY(KEY_J),
	KEY_CAPABILITY(KEY_K), KEY_CAPABILITY(KEY_L),
	KEY_CAPABILITY(KEY_M), KEY_CAPABILITY(KEY_N),
	KEY_CAPABILITY(KEY_O), KEY_CAPABILITY(KEY_P),
	KEY_CAPABILITY(KEY_Q), KEY_CAPABILITY(KEY_R),
	KEY_CAPABILITY(KEY_S), KEY_CAPABILITY(KEY_T),
	KEY_CAPABILITY(KEY_U), KEY_CAPABILITY(KEY_V),
	KEY_CAPABILITY(KEY_W), KEY_CAPABILITY(KEY_X),
	KEY_CAPABILITY(KEY_Y), KEY_CAPABILITY(KEY_Z),
	KEY_CAPABILITY(KEY_0), KEY_CAPABILITY(KEY_1),
	KEY_CAPABILITY(KEY_2), KEY_CAPABILITY(KEY_3),
	KEY_CAPABILITY(KEY_4), KEY_CAPABILITY(KEY_5),
	KEY_CAPABILITY(KEY_6), KEY_CAPABILITY(KEY_7),
	KEY_CAPABILITY(KEY_8), KEY_CAPABILITY(KEY_9),
	KEY_CAPABILITY(KEY_ESC), KEY_CAPABILITY(KEY_BACKSPACE),
	KEY_CAPABILITY(KEY_TAB), KEY_CAPABILITY(KEY_ENTER),
	KEY_CAPABILITY(KEY_SPACE), KEY_CAPABILITY(KEY_MINUS),
	KEY_CAPABILITY(KEY_EQUAL), KEY_CAPABILITY(KEY_LEFTBRACE),
	KEY_CAPABILITY(KEY_RIGHTBRACE), KEY_CAPABILITY(KEY_SEMICOLON),
	KEY_CAPABILITY(KEY_APOSTROPHE), KEY_CAPABILITY(KEY_GRAVE),
	KEY_CAPABILITY(KEY_BACKSLASH), KEY_CAPABILITY(KEY_COMMA),
	KEY_CAPABILITY(KEY_DOT), KEY_CAPABILITY(KEY_SLASH),
	KEY_CAPABILITY(KEY_LEFTSHIFT), KEY_CAPABILITY(KEY_RIGHTSHIFT),
	KEY_CAPABILITY(KEY_LEFTCTRL), KEY_CAPABILITY(KEY_RIGHTCTRL),
	KEY_CAPABILITY(KEY_LEFTALT), KEY_CAPABILITY(KEY_RIGHTALT),
	KEY_CAPABILITY(KEY_CAPSLOCK),
	KEY_CAPABILITY(KEY_HOME), KEY_CAPABILITY(KEY_UP),
	KEY_CAPABILITY(KEY_PAGEUP), KEY_CAPABILITY(KEY_LEFT),
	KEY_CAPABILITY(KEY_RIGHT), KEY_CAPABILITY(KEY_END),
	KEY_CAPABILITY(KEY_DOWN), KEY_CAPABILITY(KEY_PAGEDOWN),
	KEY_CAPABILITY(KEY_INSERT), KEY_CAPABILITY(KEY_DELETE),
	KEY_CAPABILITY(KEY_F1), KEY_CAPABILITY(KEY_F2),
	KEY_CAPABILITY(KEY_F3), KEY_CAPABILITY(KEY_F4),
	KEY_CAPABILITY(KEY_F5), KEY_CAPABILITY(KEY_F6),
	KEY_CAPABILITY(KEY_F7), KEY_CAPABILITY(KEY_F8),
	KEY_CAPABILITY(KEY_F9), KEY_CAPABILITY(KEY_F10),
};
#undef KEY_CAPABILITY
...
console_device_register(void)
{
	const struct input_device_info keyboard_info = {
	    ...
	    .capability_count =
		sizeof(keyboard_capabilities) / sizeof(keyboard_capabilities[0]),
	};
