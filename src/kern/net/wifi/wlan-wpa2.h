...
/*
 * The WPA2 supplicant engine.
 *
 * The engine drives the association and four-way handshake of one station,
 * derives the pairwise and group keys, and reports the keys it installs to
 * its owner.  It is fed management and EAPOL frames, transmit results and a
