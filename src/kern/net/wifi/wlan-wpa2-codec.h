...
/*
 * WPA2 management and EAPOL-Key frame encoding.
 *
 * The codec builds and parses the RSN information element, the
 * authentication and association exchange, and the four EAPOL-Key messages
 * of the handshake.  It performs no state transitions and holds no secrets;
