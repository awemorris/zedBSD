...
/*
 * The cryptographic primitives WPA2 needs.
 *
 * SHA-1, HMAC-SHA1, PBKDF2, AES-128 and RFC 3394 key wrapping are implemented
 * inside the kernel so that the WLAN supplicant depends on no external
