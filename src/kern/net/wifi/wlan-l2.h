...
/*
 * IEEE 802.11 data frame encoding.
 *
 * These helpers convert between Ethernet frames and 802.11 data MPDUs,
 * including the LLC/SNAP header and the CCMP header of a protected frame.
 * The receive state tracks per-key packet numbers so that a replayed frame
 * can be rejected.
 */
