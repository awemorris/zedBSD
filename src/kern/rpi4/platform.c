...
int kern_platform_boot_linux(struct zedbsd_filesystem*f,const char*p,const char*a,const struct zedbsd_device*d,unsigned n,int b)
...
int kern_platform_graphics_enter(struct kern_graphics_mode*m){(void)m;return EOPNOTSUPP;}
int kern_platform_graphics_clear(void){return EOPNOTSUPP;}
void kern_platform_graphics_leave(void){}
int kern_platform_graphics_fill(const struct kern_graphics_rect*r,uint32_t c){(void)r;(void)c;return EOPNOTSUPP;}
int kern_platform_graphics_line(unsigned a,unsigned b,unsigned c,unsigned d,uint32_t e){(void)a;(void)b;(void)c;(void)d;(void)e;return EOPNOTSUPP;}
int kern_platform_graphics_pattern_fill(const struct kern_graphics_rect*r,uint32_t c,uint64_t p){(void)r;(void)c;(void)p;return EOPNOTSUPP;}
int kern_platform_graphics_blit(unsigned x,unsigned y,const struct kern_graphics_image*i,uint64_t k,int t){(void)x;(void)y;(void)i;(void)k;(void)t;return EOPNOTSUPP;}
int kern_platform_graphics_flush(const struct kern_graphics_rect*r,size_t n){(void)r;(void)n;return EOPNOTSUPP;}
int kern_platform_graphics_get_glyph(uint32_t c,uint8_t b[32],unsigned*w,unsigned*h){(void)c;(void)b;(void)w;(void)h;return EOPNOTSUPP;}
