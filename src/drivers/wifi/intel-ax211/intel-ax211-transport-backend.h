...
#ifndef KERN_DRIVERS_INTEL_AX211_TRANSPORT_BACKEND_H
#define KERN_DRIVERS_INTEL_AX211_TRANSPORT_BACKEND_H
...
int drv_intel_ax211_transport_backend_init(
 ...
 */
int drv_intel_ax211_transport_backend_ring_memory(
