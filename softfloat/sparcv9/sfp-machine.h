/* Software floating-point machine description for SPARC V9 zedBSD.
...
/* zedBSD does not yet expose fenv; software operations use round-to-nearest
   and do not attempt to update the hardware FSR exception flags. */
