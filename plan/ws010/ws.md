...
| --- | --- | --- | --- |
| `ws010-p001` | [Noct host toolchain](phase001/phase.md) | Complete | `make toolchain` obtains pinned Noct and passes the new WS010 smoke test |
| `ws010-p002` | [x86 build-tool migration](phase002/phase.md) | Complete | The frozen 15-script production closure is replaced by Noct |
| `ws010-p003` | [x86 dependency-closure audit](phase003/phase.md) | Complete | Forced dry-runs show no Python on the three production paths |
| `ws010-p004` | [three-platform boot acceptance](phase004/phase.md) | Complete | amd64, PC/AT i386, and PC-98 i386 reach `login:` in QEMU |
| `ws010-p005` | [userland source-distribution lifecycle](phase005/phase.md) | Complete (`q063`, 2026-09-02) | All 177 maintained userland Makefiles expose download/patch/build/install and top-level download materializes declared external inputs without tracking blobs in Git |
...
- Current immutable host source is the post-2.0.1 `bb239816` archive shared with
  target Noct; [WS019-p023](../ws019/phase023/results.md)
