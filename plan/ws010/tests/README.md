...
```sh
plan/ws010/tests/run-userland-lifecycle-audit.sh
```
...
[Noct 2.0.1 evidence record](../../ws008/tests/q063-noct-2.0.1-evidence.md).

Run the real acquisition/extraction recipes against bounded local fixtures
with:

```sh
plan/ws010/tests/run-noct-acquisition-fixtures.sh
```
