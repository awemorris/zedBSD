...
| --- | --- | --- | --- |
| 1 | [ws025-p037](ws025-io-memory-cache/phase037-hal-interface-consolidation/phase.md) | uncleared | Link-only migrated owner probe, disposable 8 GiB / 4 CPU QEMU, frame rollback/sharing/scratch; restore ordinary image |
