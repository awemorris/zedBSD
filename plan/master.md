...
| `ws018` | Kernel source ownership and interface consolidation | Active; q026 ownership migration in progress | p001, p003, p004, p005, and p006 complete; p009 source/build work implemented with runtime matrix uncleared; p002 active | Execute q026 p002 -> p007 -> p008; later resume p009's explicit runtime-only evidence | [WS018](ws018-kernel-architecture/ws.md) |
