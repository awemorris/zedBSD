...
synthetic Ethernet L2 automatic milestone; p030 is dependency-ready. The remaining Noct
...
| `ws004` | Hardware expansion | Active; q058 completed the RTL8822BU p029 automatic WPA2-Personal/CCMP L2 milestone after q057's radio/scan work | `ws004-p010`--`p020`, p022--p024, p026-p029 automatic, p031--p033, and p036 complete | Execute p030 lifecycle hardening; RTL8822CE and Intel AX201 remain later independent targets | [WS004](ws004-hardware/ws.md) |
| `ws005` | Networking and WLAN | Active; q058 supplied the automatic RTL8822BU WPA2-Personal/CCMP L2 layer after q057's radio/scan milestone | Physical USB Ethernet, authenticated control, strict root/per-user credential storage, frozen design contract, exact first-radio identity, common WLAN control ABI, p036, and p028-p029 automatic milestones are complete | Let WS004 finish p030 while implementing the p004 primitive before p006 protocol composition | [WS005](ws005-networking/ws.md) |
