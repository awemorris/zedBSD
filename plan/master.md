...
lifetime, and strict CDC NCM wire profile are complete; the integrated `ueN`
software milestone remains. The archived [q026](queue-q026.md) completed the
...
| `ws004` | Hardware expansion | Active; CDC NCM software sequence in `q027` | `ws004-p010` USB function model, `p011` concurrent xHCI, `p012` network hotplug lifetime, and `p013` wire codec complete; p014 remains | Complete the integrated-driver Phase; physical NCM evidence remains WS005 | [WS004](ws004-hardware/ws.md) |
