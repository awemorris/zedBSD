...
| [WS069](ws069/ws.md) | MG006 | zwl で X11 の app を動かす（Xzed の Wayland backend: rootful → rootless、GLX）（2026-09-26 ユーザー指示） | incomplete | p002（rootful の Wayland backend） |
