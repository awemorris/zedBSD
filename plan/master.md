...
Active Queue: q458（ws035-p053、`wl_shm` と cursor）。直近: q457（ws035-p052 cleared: zdesktop の 2 つのモードの核）。直近: q456（ws062-p003 cleared: amd64 の既定を native・2 GiB に、CI は gzip）。直近の終了: q453（ws065-p003 cleared: sh の builtin の bash 拡張）
