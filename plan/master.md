...
Active Queue: q454（ws067-p001、BUG-054 の修正）。直近の終了: q453（ws065-p003 cleared: sh の builtin の bash 拡張）
...
| [WS067](ws067/ws.md) | MG002 | `/dev/fd` を呼んだ process の descriptor に合わせる（BUG-054、2026-09-26 ユーザー「最優先」） | incomplete | p001 を q454 で実行中、p002（規約） |
