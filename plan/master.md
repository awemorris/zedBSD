...
| `ws008` | Noct and BeUI | Active in `q019` | `ws008-p001` complete | Execute p002 canonical BeUI graphics/evdev migration before p003 JIT acceptance | [WS008](ws008-noct/ws.md) |
