...
build/IDE/xHCI gates pass without claiming physical RF. Q058 now implements
p029's strict WPA2-Personal/CCMP handshake, controlled port, RTL keys, and
synthetic Ethernet L2 automatic milestone. The remaining Noct
...
| `ws004` | Hardware expansion | Active; q057 completed the RTL8822BU p028 automatic radio/scan milestone after q056's pre-radio substrate and q055's exact-unit/common-core work; q058 now implements p029 secure L2 | `ws004-p010`--`p020`, p022--p024, p026-p028 automatic, p031--p033, and p036 complete; p029 is in progress | Complete q058/p029, then p030 lifecycle hardening; RTL8822CE and Intel AX201 remain later independent targets | [WS004](ws004-hardware/ws.md) |
| `ws005` | Networking and WLAN | Active; q057 supplied the automatic RTL8822BU radio/scan layer after q056's substrate and q055's common WLAN dependency | Physical USB Ethernet, authenticated control, strict root/per-user credential storage, frozen design contract, exact first-radio identity, common WLAN control ABI, p036, and p028 automatic milestone are complete | Let WS004 finish p029--p030 while implementing the p004 primitive before p006 protocol composition | [WS005](ws005-networking/ws.md) |
...
4. Implement the Archer T3U Nano USB WLAN path across WS004 and WS005. The
   ...
   completed q057 p028 scan, p029--p030 WPA2 lifecycle, then WS005 orchestration and the
...
6. Resume WS008 from the maintainer's latest accepted NoctLang tree. The host
