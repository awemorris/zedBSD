...
| --- | --- | --- | --- | --- | --- |
| `ws001` | POSIX.1-2024 compliance | Active ledger; `agent2-q006` control-layout milestone complete | `ws001-p021` mechanically complete but prose-review uncleared | Resume the file-specific semantic prose review or select the next bounded compliance item | [WS001](ws001-posix/ws.md) |
