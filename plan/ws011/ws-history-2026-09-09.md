# WS011 archive — 2026-09-09 更新前

旧設計・受け入れ条件の履歴。現在の範囲は [ws.md](ws.md) を優先する。
...
| `ws011-p003` | [Persistence and boot migration](phase003/phase.md) | Complete software milestone | Atomic authoritative configuration and boot/request evidence pass; migrated DHCP QEMU rerun remains |
| `ws011-p004` | [VLAN and bridge interfaces](phase004/phase.md) | Blocked by explicit manual hold | Resume design and implementation only after explicit user release |
...
| `ws011-p008` | [Confirmed-commit physical acceptance](phase008/phase.md) | Planned; not Queue-ready | One consolidated real-hardware remote check after p007/p009 and explicit transport/topology/recovery selection |
