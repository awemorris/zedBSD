...
Owner: [ws011-p009](../phase009/phase.md)

Queue: [q075](../../history/queue-q075.md)
...
`plan/ws011/temp/q075-diagnostic-01/` and
`plan/ws011/temp/q075-normal-matrix/`. The matrix's original failure
...
```sh
evidence_root=plan/ws011/temp/q075-postfix-NEW
