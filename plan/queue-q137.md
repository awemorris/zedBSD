...
| --- | --- | --- | --- |
| 1 | [ws006-p010](ws006-input/phase010-legacy-usb-root-recovery/phase.md) | uncleared | Paired EHCI/UHCI root ENODEV reproduction, proved correction, driver/input/root-I/O/halt regression |
