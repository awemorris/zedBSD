...
Run `python3 plan/ws019/tests/installer-confirmation-host.py` from
...
`python3 plan/ws019/tests/run-confirmation-qemu.py OUT`, with a fresh
...
files. Both use a fresh disposable fixture. See [q152 results](../phase004/q152-results.md).

Capacity prerequisite: `sh plan/ws019/tests/run-df-capacity-host.sh`
...
production builds/runtime. [q148 evidence](../phase019/results.md).
...
```sh
sh plan/ws019/tests/run-format-reservation-test.sh
sh plan/ws019/tests/run-format-file-test.sh
sh plan/ws019/tests/run-ufs1-format-test.sh
sh plan/ws019/tests/run-swap-format-test.sh
sh plan/ws016/tests/run-swap-manager-test.sh
sh plan/ws016/tests/run-swap-drain-test.sh
sh plan/ws016/tests/run-backing-claim-test.sh
sh plan/ws018/tests/run-filesystem-identity-host-test.sh
```
...
make -j16 -f Makefile -f plan/ws019/tests/formatter-qemu.mk ws019-formatter-qemu-fixture
```
...
Current-format revalidation: [p014](../phase014/phase.md), q129. Historical q078/q079 outcomes above retain their original scope.
...
not a dedicated installation. [Final results](../phase028/results.md).
