...
s=importlib.util.spec_from_file_location('pc98',R/'plan/ws025/tests/run-p032-pc98-session.py')
...
def main():
    out=Path(sys.argv[1]).resolve();out.relative_to(R/'plan/ws019/temp');out.mkdir()
