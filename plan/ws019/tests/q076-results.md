...
```sh
sh plan/ws019/tests/run-storage-foundation-test.sh
sh plan/ws019/tests/run-diskpart-table-test.sh
make -j16 sysroots
make -j16
...
python3 plan/ws019/tests/run-storage-qemu.py combined plan/ws019/temp/q076-resume-01
```
