...
Previous: [q302](queue-q302.md)

| Order | Phase | Status | Scope |
| --- | --- | --- | --- |
| 1 | [ws025-p038](ws025-io-memory-cache/phase038-hal-fixed-entry/phase.md) | uncleared | i386 normalized callback style, builds and shared x86 runtime |
