...
- KA-T121: production-linked mount/namei/inode regression retains path-based
  ...
  See [p013](../phase013/phase.md) for the Queue boundary
  and required distinctions between runtime, build and source-audit evidence.
  [P014](../phase014/phase.md) adds the explicitly
...
fixtures in [`plan/ws003/tests`](../../ws003/tests/README.md);
...
`sh plan/ws018/tests/run-pty-write-flags-test.sh` runs the
