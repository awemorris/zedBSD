...
test -e "$repo/plan/ws025/temp/p031-driver-fragments/src/drivers/input-device.c"
test -e "$repo/plan/ws025/temp/p031-driver-fragments/src/drivers/input-queue.c"
test -e "$repo/plan/ws025/temp/p031-driver-fragments/src/drivers/input-capability.c"
test -e "$repo/plan/ws025/temp/p031-driver-fragments/src/drivers/input-keymap.c"
...
if rg -n 'src/kern/(console-device|input-(device|queue|capability|keymap)|mouse-device)\.c|src/drivers/(pcat-ps2-mouse|pc98-busmouse)\.c' \
	"$repo/platform" "$repo/Makefile" "$repo/plan/ws006/tests"; then
