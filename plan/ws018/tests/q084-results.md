...
Date: 2026-09-06
Phase: [ws018-p016](../phase016/phase.md)
Status: completed
...
- Both inputs and the ancestor/recent patch are retained in the ignored
  `plan/ws018/temp/q084-integration/` directory.
...
- `run-storage-qemu.py combined plan/ws019/temp/q084-storage-integration --mount-protection`:
  mounted namespace protection, idle/busy partition reload behavior, current
  mount inventory and post-reboot persistence pass.
- `run-formatter-qemu.py combined plan/ws019/temp/q084-formatter-integration`:
