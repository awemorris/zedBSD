...
compile plan/ws025/temp/p031-driver-fragments/src/drivers/fs/fat.c fat.o
compile src/kern/swap.c swap.o
compile src/kern/swap-format.c swap-format.o
compile plan/ws025/temp/p031-driver-fragments/src/drivers/fs/ufs/ufs-endian.c ufs-endian.o
compile plan/ws025/temp/p031-driver-fragments/src/drivers/fs/ufs/ufs-super.c ufs-super.o
compile plan/ws025/temp/p031-driver-fragments/src/drivers/fs/ufs/ufs-vfs.c ufs-vfs.o
