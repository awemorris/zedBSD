...
| --- | --- | --- | --- |
| 1 | [ws025-p007](ws025-io-memory-cache/phase007-buffer-runs/phase.md) | completed | Preserve contiguous caller buffers through cache runs; prepare references before any multi-line busy ownership. Requires completed p001. |
