...
| --- | --- | --- | --- |
| 1 | [ws025-p013](ws025-io-memory-cache/phase013-fat-metadata-batching/phase.md) | completed | Merge FAT table/mirror updates with bounded synchronous ownership and explicit publication/rollback order. p012 and p014 complete. |
