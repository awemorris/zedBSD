...
| --- | --- | --- | --- |
| 1 | [ws002-p024](ws002-services/phase024-retirement-heap-integrity/phase.md) | uncleared | Daybreak proved and corrected the UHCI stale-link heap writer; the independent missing-login owner-count regression remains red |
