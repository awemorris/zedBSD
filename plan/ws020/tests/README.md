...
build/NoctLang/build-static/noct --path=tools/build \
  plan/ws020/tests/target-artifact-invariance.noct \
  . plan/ws020/temp/p001-artifact-invariance
```
...
```sh
build/NoctLang/build-static/noct --path=tools/build \
  plan/ws020/tests/image-layout-test.noct \
  . plan/ws020/temp/p002-layout
```
...
```sh
build/NoctLang/build-static/noct --path=tools/build \
  plan/ws020/tests/qemu-uefi-larger-media.noct \
  . plan/ws020/temp/p005-production-preflight
```
...
```sh
build/NoctLang/build-static/noct --path=tools/build \
  plan/ws020/tests/qemu-uefi-relocated-gpt.noct \
  . plan/ws020/temp/p006-relocated-gpt
```
