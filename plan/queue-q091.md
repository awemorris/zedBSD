...
| --- | --- | --- | --- |
| 1 | [ws025-p004](ws025-io-memory-cache/phase004-physical-allocator-dma/phase.md) | completed | Range-based RAM ownership, constrained allocation and DMA masks. Requires completed p003; keep the normal high-memory publication gate closed until p005. |
