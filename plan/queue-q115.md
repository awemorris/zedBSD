...
| --- | --- | --- | --- |
| 1 | [ws025-p021](ws025-io-memory-cache/phase021-ufs-metadata-writeback/phase.md) | uncleared | Integrate opt-in durable metadata publication with bounded deferred checkpoint, full-slot draining, filesystem sync/snapshot/unmount and error ownership. Depends on verified q111–q114 journal, metadata/orphan and immutable reader owners. |
