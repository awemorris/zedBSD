...
for variant in ('sanitize','ordinary'):
 ...
 subprocess.run(['cc','-DZEDBSD_USER_ABI_LP64',*extra,'-O1','-g','-pthread','-c','plan/ws018/tests/mount-thread-host.c','-o',str(bridge)],cwd=repo,check=True)
