...
repo=Path(__file__).resolve().parents[3];out=Path(sys.argv[1]).resolve();out.relative_to(repo/'plan/ws025/temp');out.mkdir(exist_ok=False)
...
paths=['src/hal/amd64/space.c','include/hal/hal.h','plan/ws025/tests/system-space-host.c']
