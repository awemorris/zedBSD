...
sources=['src/kern/io-stats.c','plan/ws025/tests/fat-cache-private-host.c']
(out/'source.json').write_text(json.dumps({s:hashlib.sha256((repo/s).read_bytes()).hexdigest() for s in [*sources, "plan/ws025/temp/p031-driver-fragments/src/drivers/fs/fat.c"]},indent=2)+'\n')
commands=[]
