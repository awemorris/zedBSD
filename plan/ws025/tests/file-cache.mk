...
$(WS025_CACHE_OBJECT): plan/ws025/tests/file-cache-native.c $(ZEDBSD_SYSROOT_AMD64)/.zedbsd-sysroot-complete
	@mkdir -p $(dir $@)
...
$(eval $(call ZEDBSD_ARCH_UFS_IMAGE_RULE,$(ARCH_IMAGE_DIR)/amd64-ws025-cache.ufs,amd64,\
	$(AMD64_ARCH_INPUTS) $(WS025_CACHE_GUEST) $(WS019_GUEST) $(ZEDBSD_CONFIG) plan/ws025/tests/file-cache-lower.txt,\
	$(AMD64_ARCH_FILES) --file /usr/bin/file-cache=$(WS025_CACHE_GUEST) \
	--file /usr/bin/storage-exit=$(WS019_GUEST) \
	--file /etc/ws025-cache-lower=plan/ws025/tests/file-cache-lower.txt))
