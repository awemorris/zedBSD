...
$(WS025_ASYNC_OBJECT): plan/ws025/tests/async-native.c $(ZEDBSD_SYSROOT_AMD64)/.zedbsd-sysroot-complete
	@mkdir -p $(dir $@)
...
$(WS025_ASYNC_KERNEL): plan/ws025/tests/async-native-kernel.c $(ZEDBSD_SYSROOT_AMD64)/.zedbsd-sysroot-complete
	@mkdir -p $(dir $@)
