...
tracked = ['plan/ws025/temp/p031-driver-fragments/src/drivers/fs/fat.c', 'plan/ws025/temp/p031-driver-fragments/src/drivers/fs/fat-batch.inc',
    'plan/ws025/tests/fat-batch-private-host.c',
    'plan/ws025/tests/fat-batch-cost-host.c',
    'plan/ws018/tests/fat-native-vfs-host-test.c']
