...
groups = {
    "framebuffer-map": ["plan/ws025/tests/framebuffer-map-host.c",
                        "src/hal/amd64/framebuffer-map.c"],
    "pmem-retire": ["plan/ws025/tests/pmem-retire-host.c",
                    "src/hal/amd64/pmem-range.c"],
    "pmem-compat": ["plan/ws025/tests/pmem-compat-host.c",
                    "src/hal/pmem-constraints.c"],
    "pmem-range": ["plan/ws025/tests/pmem-range-host.c",
                   "src/hal/amd64/pmem-range.c"],
    "dma-range": ["plan/ws025/tests/dma-range-host.c",
                  "plan/ws025/temp/p031-driver-fragments/src/drivers/dma.c", "src/hal/amd64/pmem-range.c", "src/kern/io-stats.c"],
    "dma-compat": ["plan/ws004/tests/dma-constraints-test.c",
                   "plan/ws025/temp/p031-driver-fragments/src/drivers/dma.c", "src/hal/pmem-constraints.c", "src/kern/io-stats.c"],
    "dma-lock": ["plan/ws003/tests/dma-allocation-lock-test.c",
                 "plan/ws025/temp/p031-driver-fragments/src/drivers/dma.c", "src/hal/pmem-constraints.c", "src/kern/io-stats.c"],
    "ram-map": ["plan/ws025/tests/ram-map-host.c",
                "src/hal/amd64/ram-map.c"],
    "legacy-parameters": ["plan/ws003/tests/x86-parameter-handoff-test.c",
                          "src/hal/x86/boot-parameters.c",
                          "src/hal/amd64/bsp-pcat/handoff-validation.c"],
    "legacy-uefi-map": ["plan/ws003/tests/uefi-memory-map-test.c",
                        "bootloader/uefi/memory-map.c"],
    "normalize": ["plan/ws025/tests/memory-normalize-host.c",
                  "bootloader/common/memory-map.c"],
    "handoff": ["plan/ws025/tests/memory-handoff-host.c",
...
for variant in ("ordinary", "sanitize"):
    for name, sources in groups.items():
        if name.startswith("dma-"):
            sources = [*sources, "plan/ws025/tests/host-fatal.c"]
