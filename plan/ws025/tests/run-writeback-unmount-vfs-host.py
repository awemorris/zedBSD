#!/usr/bin/env python3
"""Real namespace/inode teardown with retained policy reference failure injection."""
...
sources=['src/kern/mount.c','src/kern/inode.c','src/kern/namei.c','src/kern/namecache.c','src/kern/cwdinfo.c','plan/ws025/tests/writeback-unmount-vfs-host.c']
