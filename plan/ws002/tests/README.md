...
`make -j16 ZEDBSD_CONFIG=config/ci/config-amd64.mk -f Makefile -f plan/ws019/tests/installer-qemu.mk ws019-installer-qemu-fixture`.
Run `python3 plan/ws002/tests/run-usb-halt-qemu.py plan/ws002/temp/NEW`,
...
`make -j16 ZEDBSD_CONFIG=config/ci/config-pcat.mk -f Makefile -f plan/ws002/tests/missing-login-lifecycle.mk ws002-lifecycle-fixture`
