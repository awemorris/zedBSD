...
| --- | --- | --- | --- |
| 1 | [ws025-p037](ws025-io-memory-cache/phase037-hal-interface-consolidation/phase.md) | uncleared | Populate frames before mapping; group adjacent PA runs; rollback tests and supported builds |
