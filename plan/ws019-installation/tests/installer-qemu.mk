...
WS019_INSTALL_SCRIPTS := userland/base/zedinst/selection.noct plan/ws019-installation/tests/installer-selection.noct plan/ws019-installation/tests/installer-scratch.noct \
 userland/base/zedinst/commands.noct userland/base/zedinst/identity.noct \
 plan/ws019-installation/tests/installer-identity.noct plan/ws019-installation/tests/installer-command.noct
$(eval $(call ZEDBSD_ARCH_UFS_IMAGE_RULE,$(WS019_INSTALL_UFS),amd64,\
 ...
 --file /usr/lib/zedinst/installer-selection.noct=plan/ws019-installation/tests/installer-selection.noct \
 --file /usr/lib/zedinst/installer-scratch.noct=plan/ws019-installation/tests/installer-scratch.noct \
 --file /usr/lib/zedinst/identity.noct=userland/base/zedinst/identity.noct \
 --file /usr/lib/zedinst/installer-identity.noct=plan/ws019-installation/tests/installer-identity.noct \
 --file /usr/lib/zedinst/installer-command.noct=plan/ws019-installation/tests/installer-command.noct))
