...
sources=['src/kern/mount.c','src/kern/inode.c','src/kern/namei.c','src/kern/namecache.c','src/kern/cwdinfo.c','plan/ws019-installation/tests/publication-vfs-host.c']
