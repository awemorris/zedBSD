...
Parent: [test index](README.md); [finished q078](../../queue-q078.md).
Phases: [p008](../phase008-target-mkfs/phase.md),
[p009](../phase009-target-mkswap/phase.md).
...
```sh
python3 plan/ws019-installation/tests/run-formatter-qemu.py format plan/ws019-installation/temp/q078-format-01
python3 plan/ws019-installation/tests/run-formatter-qemu.py format plan/ws019-installation/temp/q078-format-02
python3 plan/ws019-installation/tests/run-formatter-qemu.py format plan/ws019-installation/temp/q078-format-03
python3 plan/ws019-installation/tests/run-formatter-qemu.py combined plan/ws019-installation/temp/q078-combined-04
```
