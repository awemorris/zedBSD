...
for mode in normal sanitize; do
    ...
    ${CC:-cc} -std=c11 -O1 -g $flags -pthread -c \
        plan/ws018-kernel-architecture/tests/mount-thread-host.c -o "$out/thread.o"
    ${CC:-cc} -std=c11 -O1 -g $flags -DZEDBSD_USER_ABI_LP64 \
        -Wall -Wextra -Werror -ffunction-sections -fdata-sections \
        -I. -Iinclude -Iinclude/uapi -Isrc -Ilibc/include \
        -Iplan/ws018-kernel-architecture/tests \
        plan/ws019-installation/tests/ufs-file-extents-host.c \
