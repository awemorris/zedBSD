...
WS019_STAGING_SCRIPTS := userland/base/zedinst/commands.noct \
 plan/ws019-installation/tests/staging-command.noct \
 plan/ws019-installation/tests/staging-files.noct
$(eval $(call ZEDBSD_ARCH_UFS_IMAGE_RULE,$(WS019_STAGING_UFS),amd64,\
 ...
 --file /usr/lib/zedinst/staging-command.noct=plan/ws019-installation/tests/staging-command.noct \
 --file /usr/lib/zedinst/staging-files.noct=plan/ws019-installation/tests/staging-files.noct))
