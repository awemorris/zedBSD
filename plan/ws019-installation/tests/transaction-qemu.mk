...
include plan/ws019-installation/tests/formatter-qemu.mk
WS019_TRANSACTION_UFS := $(ARCH_IMAGE_DIR)/amd64-ws019-transaction.ufs
WS019_NESTED_MOUNT := $(BUILD)/tests/nested-mount
WS019_NESTED_OBJECT := $(BUILD)/user64/plan/ws019-installation/tests/nested-mount-guest.o
...
WS019_TRANSACTION_SCRIPTS := userland/base/zedinst/commands.noct \
 ...
 userland/base/zedinst/destination.noct plan/ws019-installation/tests/installer-destination.noct \
 userland/base/zedinst/preflight.noct plan/ws019-installation/tests/installer-preflight.noct \
 userland/base/zedinst/workspace.noct plan/ws019-installation/tests/installer-workspace.noct \
 userland/base/zedinst/confirmation.noct plan/ws019-installation/tests/installer-confirmation.noct \
 userland/base/zedinst/admission.noct \
 userland/base/zedinst/metadata.noct plan/ws019-installation/tests/installer-metadata.noct \
 userland/base/zedinst/discovery.noct plan/ws019-installation/tests/installer-discovery.noct \
 userland/base/zedinst/source.noct userland/base/zedinst/selection.noct \
 plan/ws019-installation/tests/installer-source.noct \
 plan/ws019-installation/tests/noct-large-seek.noct \
 userland/base/zedinst/identity.noct userland/base/zedinst/transaction.noct \
 userland/base/zedinst/files.noct plan/ws019-installation/tests/installer-files.noct \
 plan/ws019-installation/tests/installer-admission.noct \
 plan/ws019-installation/tests/installer-transaction.noct
$(eval $(call ZEDBSD_ARCH_UFS_IMAGE_RULE,$(WS019_TRANSACTION_UFS),amd64,\
 ...
 --file /usr/lib/zedinst/installer-destination.noct=plan/ws019-installation/tests/installer-destination.noct \
 --file /usr/lib/zedinst/preflight.noct=userland/base/zedinst/preflight.noct \
 --file /usr/lib/zedinst/installer-preflight.noct=plan/ws019-installation/tests/installer-preflight.noct \
 --file /usr/lib/zedinst/workspace.noct=userland/base/zedinst/workspace.noct \
 --file /usr/lib/zedinst/installer-workspace.noct=plan/ws019-installation/tests/installer-workspace.noct \
 --file /usr/lib/zedinst/confirmation.noct=userland/base/zedinst/confirmation.noct \
 --file /usr/lib/zedinst/installer-confirmation.noct=plan/ws019-installation/tests/installer-confirmation.noct \
 ...
 --file /usr/lib/zedinst/installer-discovery.noct=plan/ws019-installation/tests/installer-discovery.noct \
 --file /usr/lib/zedinst/installer-metadata.noct=plan/ws019-installation/tests/installer-metadata.noct \
 ...
 --file /usr/lib/zedinst/installer-source.noct=plan/ws019-installation/tests/installer-source.noct \
 --file /usr/lib/zedinst/noct-large-seek.noct=plan/ws019-installation/tests/noct-large-seek.noct \
 ...
 --file /usr/lib/zedinst/installer-admission.noct=plan/ws019-installation/tests/installer-admission.noct \
 --file /usr/lib/zedinst/installer-files.noct=plan/ws019-installation/tests/installer-files.noct \
 --file /usr/lib/zedinst/installer-transaction.noct=plan/ws019-installation/tests/installer-transaction.noct))
