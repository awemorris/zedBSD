...
Reproducer: `python3 plan/ws019-installation/tests/run-pc98-cache-memory-qemu.py
plan/ws019-installation/temp/NEW-UNUSED-DIRECTORY`. It prints STATUS and BEFORE /
...
plan/ws025-io-memory-cache/tests/run-pinned-cache-host.sh`.
