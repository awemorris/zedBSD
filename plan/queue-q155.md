...
| --- | --- | --- | --- |
| 1 | [ws019-p022](ws019-installation/phase022-tmpfs-unmount/phase.md) | completed | 30320 host checks each, regressions, three builds and populated native teardown pass |
| 2 | [ws019-p023](ws019-installation/phase023-noct-large-seek/phase.md) | completed | Updated canonical revision; host/native >4-GiB file and 5-GiB backup-GPT reads pass |

Standing autonomous authorization covers the [ownership design](ws019-installation/phase022-tmpfs-unmount/design.md).
...
Results: [tmpfs](ws019-installation/phase022-tmpfs-unmount/results.md),
[Noct](ws019-installation/phase023-noct-large-seek/results.md).
