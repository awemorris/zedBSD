...
| --- | --- | --- | --- |
| 1 | [ws019-p050](ws019-installation/phase050-pc98-graphic-fat/phase.md) | completed | Resolve BUG-020 using ownership-safe clean-page reclaim; focused host and PC98 regression; resume two-IDE install and destination-only boot |
