...
| --- | --- | --- | --- |
| 1 | [ws006-p011](ws006-input/phase011-terminal-identity/phase.md) | completed | libc terminal identity; native error/bounds tests and three builds pass |
| 2 | [ws006-p009](ws006-input/phase009-consumer-legacy-removal/phase.md) | completed | Actual Xzed PTY/input and restored TTY pass on both topologies |
| 3 | [ws006-p010](ws006-input/phase010-legacy-usb-root-recovery/phase.md) | completed | Ordinary paired USB-root read, HID and hotplug replay passes |
...
Final evidence: [q147 results](ws006-input/phase011-terminal-identity/results.md).
