...
- [WS002](../ws002/ws.md) supplies init, service definitions,
  supervision, `/etc/rc.conf`, and the current argv command.
- [WS013](../ws013/ws.md) may later add container-specific status
...
| --- | --- | --- | --- |
| `ws012-p001` | [Service-console design discussion](phase001/phase.md) | Complete | YAML, ZSV1, grammar, policy, permissions, and concurrency decisions accepted |
| `ws012-p002` | [YAML rc.conf model and persistence foundation](phase002/phase.md) | Complete (`q017`) | Strict model, parser, canonical writer, stable lock, atomic replacement, and all-reader migration |
| `ws012-p003` | [ZSV1 init service-control protocol](phase003/phase.md) | Complete (`q018`, 2026-08-28) | Replace the old socket grammar with bounded versioned service/system-action records and typed service/shutdown clients |
| `ws012-p004` | [Non-interactive service CLI and persistent policy](phase004/phase.md) | Complete (`q018`, 2026-08-28) | Stable argv grammar/output, runtime controls, immediate locked enable/disable, and reload |
| `ws012-p005` | [Interactive service console](phase005/phase.md) | Complete (`q018`, 2026-08-28) | Argument-free prompt reuses the argv dispatcher with no candidate/save state |
| `ws012-p006` | [Service-console integration acceptance](phase006/phase.md) | Complete (`q018`, 2026-08-28) | Host/QEMU lifecycle, concurrency, persistence, failure, cold boot, and documentation evidence |
...
[`ws001-p014`](../ws001/phase014/phase.md), not hidden
