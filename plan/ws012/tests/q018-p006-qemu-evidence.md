...
```sh
./plan/ws012/tests/host-service-acceptance.sh \
...
```sh
make -j16
./plan/ws012/tests/qemu-service-acceptance.sh \
...
job-control residuals are not hidden: [ws001-p014](../../ws001/phase014/phase.md)
