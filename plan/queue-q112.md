...
| --- | --- | --- | --- |
| 1 | [ws025-p021](ws025-io-memory-cache/phase021-ufs-metadata-writeback/phase.md) | uncleared | Group unlink entry/link count and explicit cache/lifetime outcome; inspect shared-dinode staging for subsequent link/namespace operations. Depends on verified q111 metadata commit/allocation/release owners. |
