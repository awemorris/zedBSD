...
| --- | --- | --- | --- |
| 1 | [ws025-p029](ws025-io-memory-cache/phase029-uas/phase.md) | uncleared | Guest keeps old block fd open across unplug/replacement; old read/write/fsync refuse, close permits new binding, new pattern readback |
