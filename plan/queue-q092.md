...
| --- | --- | --- | --- |
| 1 | [ws025-p005](ws025-io-memory-cache/phase005-high-memory-acceptance/phase.md) | completed | Remove normal 1 GiB publication gate, release proven obsolete boot owners, exercise native high PFNs and DMA32. Requires completed p004. |
