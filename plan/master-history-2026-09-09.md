...
| `ws004` | Hardware expansion | P046 complete q083; p047/p048 complete (`q085`) | Independent checked stop and observable completion; focused common/AX211/RTL lifecycle gates and three builds pass | Q085 RF/QEMU untested; prior hardware evidence remains historical; other hardware follow-ups retained | [WS004](ws004-hardware/ws.md) |
| `ws005` | Networking and WLAN | Historical q071 acceptance; p012 complete (`q085`) | Managed rewrite/P048 integration; all 30 ordinary and sanitized command stories, regressions and builds pass | Individual host acceptance evidence in P012; nonblocking list preserved; physical RF not rerun | [WS005](ws005-networking/ws.md) |
...
nested mount path. [Evidence and corrected resume](ws019-installation/tests/q076-results.md)
