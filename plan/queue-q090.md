...
| --- | --- | --- | --- |
| 1 | [ws025-p003](ws025-io-memory-cache/phase003-amd64-direct-map/phase.md) | completed | Separate the RAM direct map from the kernel image and MMIO, construct sparse tables from firmware ranges, retain low allocation until p005. Requires completed p002. |
...
Result: sparse RAM map, image/MMIO separation, shared roots and expanding early arena completed. Host ordinary/sanitizer, three builds, BIOS/UEFI low/high boots, forced expansion and diagnosed exhaustion passed. See [p003 results](ws025-io-memory-cache/phase003-amd64-direct-map/results.md).
