...
| 4 | `ws016-p004` | [WS016](ws016-swap-control/ws.md), [Phase](ws016-swap-control/phase004-runtime-swap-acceptance/phase.md), [tests](ws016-swap-control/tests/README.md) | complete | Disposable amd64 QEMU images prove runtime add, page-out/in, safe installed-command drain/remove, failure preservation, ID reuse, and boot-swap regression |
