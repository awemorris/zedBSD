...
| --- | --- | --- | --- |
| 1 | [ws025-p029](ws025-io-memory-cache/phase029-uas/phase.md) | uncleared | Add closed-admission inode ownership check using proven VM refs outside inode-cache lock; verify external refusal and temporary-pin cleanup; three builds |
