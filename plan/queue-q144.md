...
| --- | --- | --- | --- |
| 1 | [ws025-p029](ws025-io-memory-cache/phase029-uas/phase.md) | uncleared | Both speeds captured, kernel enumerates protocol 62; parser and transport implementation remain |
