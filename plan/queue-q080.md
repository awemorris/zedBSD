...
| --- | --- | --- | --- |
| 1 | [ws004-p046](ws004-hardware/phase046-archer-t3u-plus-driver/phase.md) | uncleared | Extend exact Plus HS/SS transport and prove both supplied bands; depends on completed p045 and the existing RTL8822BU/WLAN baseline |
...
Record [q080 evidence](ws004-hardware/tests/q080-results.md), synchronize
