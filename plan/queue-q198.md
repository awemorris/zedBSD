...
| --- | --- | --- | --- |
| 1 | [ws025-p029](ws025-io-memory-cache/phase029-uas/phase.md) | uncleared | Implement xHCI primary stream rings, request provenance, dequeue/restart/free ownership and explicit gated USB endpoint configuration; focused checks/builds |
