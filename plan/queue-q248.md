...
| --- | --- | --- | --- |
| 1 | [ws025-p037](ws025-io-memory-cache/phase037-hal-interface-consolidation/phase.md) | uncleared | PA-capable query across HALs, kernel range API, amd64 SYS operations with shared table ownership; focused tests and builds |
