...
| NET-T31 | Archer identity subrecord | Within NET-T32, not as another physical gate, the exact unit matches the provisional `2357:012e`/RTL8822BU T3U Nano profile, `bcdDevice`, descriptors, and firmware; RTL8828BU and other revisions are not inferred |
