...
| NET-T35 | Primitive abnormal-path hardening | After NET-T34, exhaustive public CLI boundaries, scan generations, terminal errors, cancellation, races, detach, cleanup, output limits, and secret-redaction variants pass without taking ownership from p006/p007 or WS004 p030 |
