<!-- awesome-plan project=zedbsd record=ws003-p039 -->
...
2026-09-12、[ws027-p007](https://github.com/awemorris/zedBSD/issues/381)（[ws027](https://github.com/awemorris/zedBSD/issues/374)）へ計画を移管。旧Phaseは取消・終了し再利用しない。実行・完了を意味しない。
...
# ws003-p039: PPC/OHCI変更の最終規約・統合確認
...
限定した通常起動・必要な回帰と全規約確認の結果、未実施/未対応が一覧化される。初期目標p035の完了を後続未完了で取り消さず、最終USB image構成と実機受け入れ境界を明確に引き継ぐ。
