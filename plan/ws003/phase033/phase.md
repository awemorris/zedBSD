<!-- awesome-plan project=zedbsd record=ws003-p033 -->
...
2026-09-12、[ws027-p001](https://github.com/awemorris/zedBSD/issues/375)（[ws027](https://github.com/awemorris/zedBSD/issues/374)）へ計画を移管。旧Phaseは取消・終了し再利用しない。実行・完了を意味しない。
...
# ws003-p033: OF起動契約・APM/FAT imageとXCOFFローダ入口
