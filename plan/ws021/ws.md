...
| --- | --- | --- |
| [`ws021-p001`](phase001/phase.md) | Complete (`q064`) | Verified LLVM 23.1.0 acquisition and strict zedBSD OS/triple/driver/compiler-rt patch boundary |
| [`ws021-p002`](phase002/phase.md) | Complete (`q064`) | `make toolchain` installs the required X86 Clang/LLD/LLVM tools below `build/llvm/` while host Noct remains host-built |
| [`ws021-p007`](phase007/phase.md) | Complete (`q064`) | Publish the validated x86_64 Linux host install as a pinned permanent `rev-0` CI asset |
| [`ws021-p003`](phase003/phase.md) | Complete (`q064`) | Complete amd64 and shared i386 public sysroots with startup, libc, compiler builtins, and linker inputs |
| [`ws021-p004`](phase004/phase.md) | Complete (`q064`) | All x86 kernels and userland, including target Noct, compile/link only through the project LLVM toolchain and sysroots |
| [`ws021-p005`](phase005/phase.md) | Complete (`q064`) | BIOS and UEFI loaders plus all x86 disk images build without host target GNU/MinGW tools |
| [`ws021-p006`](phase006/phase.md) | Complete (`q064`) | One final consolidated amd64/i386/PC-98 QEMU campaign accepts the migrated toolchain and target Noct |
