...
```sh
bash plan/ws022/tests/build-tls-fixtures.sh plan/ws022/temp/q128-fixtures
bash plan/ws022/tests/run-static-tls-host.sh plan/ws022/temp/owner
ZEDBSD_TEST_CONFIG="$PWD/config/ci/config-amd64.mk" COMMAND_TIMEOUT_SECONDS=120 \
  bash plan/ws022/tests/qemu-tls-loader.sh plan/ws022/temp/amd64
TLS_TEST_ARCH=i386 ZEDBSD_TEST_CONFIG="$PWD/config/ci/config-pcat.mk" COMMAND_TIMEOUT_SECONDS=120 \
  bash plan/ws022/tests/qemu-tls-loader.sh plan/ws022/temp/i386
```
