...
| --- | --- | --- | --- |
| 1 | [ws025-p001](ws025-io-memory-cache/phase001-baseline-contracts/phase.md) | completed | Layered I/O and RAM counters; FS50/Wi-Fi30, focused gates, three x86 builds and 404 native benchmark samples pass. [Results](ws025-io-memory-cache/phase001-baseline-contracts/results.md) |
