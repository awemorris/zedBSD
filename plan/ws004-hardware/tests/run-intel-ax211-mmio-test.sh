...
build_dir=$(mktemp -d "${TMPDIR:-/tmp}/zedbsd-intel-ax211-mmio.XXXXXX")
...
$cc $warnings -O2 "$source" "$fixture" \
	-o "$build_dir/intel-ax211-mmio"
"$build_dir/intel-ax211-mmio"
...
$cc $warnings -O1 -g -fno-omit-frame-pointer \
	...
	-o "$build_dir/intel-ax211-mmio-sanitize"
ASAN_OPTIONS=detect_leaks=1:halt_on_error=1 \
	UBSAN_OPTIONS=halt_on_error=1:print_stacktrace=1 \
	"$build_dir/intel-ax211-mmio-sanitize"

# Static lifetime and bounds analysis gate.
# shellcheck disable=SC2086
$cc $warnings -O0 -fanalyzer "$source" "$fixture" \
	-o "$build_dir/intel-ax211-mmio-analyzer"
"$build_dir/intel-ax211-mmio-analyzer"
...
echo "intel ax211 mmio: ordinary, ASan/UBSan, analyzer, amd64/i386 syntax PASS"
