...
sources="$repo_root/src/kern/net/wifi/wlan.c $repo_root/src/kern/net/wifi/wlan-frame.c \
$repo_root/src/kern/net/wifi/wlan-crypto.c \
$repo_root/src/kern/net/wifi/wlan-wpa2-codec.c \
$repo_root/src/kern/net/wifi/wlan-wpa2.c $repo_root/src/kern/net/wifi/wlan-l2.c"
