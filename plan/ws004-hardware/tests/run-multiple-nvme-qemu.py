...
def main():
 out=Path(sys.argv[1]).resolve();out.relative_to(R/'plan/ws004-hardware/temp');out.mkdir(parents=True)
 accepted=R/'plan/ws019-installation/temp/q184-graphic-coexist1'
