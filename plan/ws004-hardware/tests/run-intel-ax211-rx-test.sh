...
build_dir=$(mktemp -d "${TMPDIR:-/tmp}/zedbsd-intel-ax211-rx.XXXXXX")
trap 'rm -rf "$build_dir"' EXIT HUP INT TERM

cc=${CC:-cc}
warnings="-std=c11 -Wall -Wextra -Werror"
sources="$repo_root/src/drivers/wifi/intel-ax211/intel-ax211-protocol.c"
sources="$sources $repo_root/src/drivers/wifi/intel-ax211/intel-ax211-rx.c"
fixture="$test_dir/intel-ax211-rx-test.c"
...
echo "intel ax211 RX MPDU: ordinary, ASan/UBSan, analyzer, amd64/i386 syntax PASS"
