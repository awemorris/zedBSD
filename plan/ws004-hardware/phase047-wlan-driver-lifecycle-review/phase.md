...
[P048 evidence and hardware coverage limits](../phase048-wlan-deferred-stop/results.md).
...
Disposable logs are
`plan/ws005-networking/temp/q085-wifi-scenarios/drivers-{amd64,pcat,pc98}-build.log`.
