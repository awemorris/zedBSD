...
Logs below are under `plan/ws005/temp/q085-wifi-scenarios/`.
The maintained runners execute production code with explicit external doubles.

| Runner under `plan/ws004/tests/` | Evidence / result |
| --- | --- |
...
[individual outcomes and reproducible commands](../../ws005/phase012/results.md).
