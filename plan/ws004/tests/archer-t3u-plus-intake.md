...
Phase: [ws004-p045](../phase045/phase.md), complete

Implementation follow-up: [ws004-p046](../phase046/phase.md), planned
...
make -j16 -C userland/firmware/rtl8822b download \
  RTL8822B_FIRMWARE_CACHE_ROOT=/home/awe/zedBSD/plan/ws004/temp/p045-firmware
```
