...
fixture="$root/plan/ws004/tests/legacy-hcd-concurrent-hotplug-test.c"
...
qemu_runner="$root/plan/ws004/tests/run-legacy-hcd-concurrent-hotplug-qemu.sh"
qemu_config="$root/plan/ws004/tests/config-amd64-legacy-hcd.mk"
