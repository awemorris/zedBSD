...
fixture="$root/plan/ws004/tests/usb-recovery-contract-test.c"
function_fixture="$root/plan/ws004/tests/usb-function-model-test.c"
unregister_fixture="$root/plan/ws003/tests/usb-hcd-unregister-test.c"
binding_runner="$root/plan/ws004/tests/run-usb-binding-transactions-test.sh"
