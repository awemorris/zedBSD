...
WS004_P019_PROBE_SOURCE := \
	plan/ws004/tests/usb-cdc-ecm-guest-probe.c
WS004_P019_PROBE_OBJECT := \
	$(BUILD)/user64/plan/ws004/tests/usb-cdc-ecm-guest-probe.o
WS004_P019_PROBE := $(BUILD)/tests/usb-cdc-ecm-guest-probe
WS004_P019_STATIC_RC := \
	plan/ws004/tests/qemu-usb-cdc-ecm-rc-static.conf
WS004_P019_DHCP_RC := \
	plan/ws004/tests/qemu-usb-cdc-ecm-rc-dhcp.conf
WS004_P019_STATIC_SERVICE := \
	plan/ws004/tests/qemu-usb-cdc-ecm-service-static
WS004_P019_DHCP_SERVICE := \
	plan/ws004/tests/qemu-usb-cdc-ecm-service-dhcp
