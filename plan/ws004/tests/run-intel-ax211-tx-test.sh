...
build_dir=$(mktemp -d "${TMPDIR:-/tmp}/zedbsd-intel-ax211-tx.XXXXXX")
...
fixture="$test_dir/intel-ax211-tx-test.c"
...
echo "intel ax211 TX codec: ordinary, ASan/UBSan, analyzer, amd64/i386 syntax PASS"
