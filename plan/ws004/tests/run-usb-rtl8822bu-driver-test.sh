...
cc=${CC:-cc}
common="-std=c11 -Wall -Wextra -Werror -pthread -I$repo/plan/ws004/tests/host-include -I$repo/include -I$repo/include/uapi"
source=$repo/plan/ws004/tests/usb-rtl8822bu-driver-test.c
...
$cc $common -O0 -fanalyzer "$source" "$security" \
	-o "$temporary/driver-test-analyzer"
