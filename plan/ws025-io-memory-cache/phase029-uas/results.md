...
`sh plan/ws025-io-memory-cache/tests/run-ufs-revoked-host.sh` passes ordinary and
...
`sh plan/ws025-io-memory-cache/tests/run-inode-revoked-host.sh` passed ordinary and
