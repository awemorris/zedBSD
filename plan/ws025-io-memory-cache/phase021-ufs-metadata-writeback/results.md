...
`plan/ws024-unified-ufs/temp/ws025-p021-foundation/results.json`; transcript
...
- `temp/p021-single-format-producers.log`: 12 target cells, six three-producer
  ...
  live in `plan/ws024-unified-ufs/temp/ws025-p021-single-format-producers`.
...
- `plan/ws024-unified-ufs/temp/ws025-p021-single-format/results.json`: new-profile
...
- `plan/ws024-unified-ufs/temp/ws025-p021-obsolete-journal/results.json`: a disposable
...
pass in `plan/ws024-unified-ufs/temp/ws025-p021-commit-proof/results.json` and
...
adapter in `plan/ws024-unified-ufs/temp/ws025-p021-pending/results.json` and
...
`plan/ws024-unified-ufs/temp/ws025-p021-outcome/results.json`;
...
- `temp/p021-image-driver.log` and
  `plan/ws024-unified-ufs/temp/ws025-p021-image-driver`: actual UFS metadata,
...
- `plan/ws024-unified-ufs/temp/ws025-p021-image/results.json`: current-profile
...
`plan/ws024-unified-ufs/temp/ws025-p021-allocation-driver-final`.
...
`plan/ws024-unified-ufs/temp/ws025-p021-allocation/results.json` and
...
`plan/ws024-unified-ufs/temp/ws025-p021-tree-driver`.
...
remount/reboot pass in `plan/ws024-unified-ufs/temp/ws025-p021-tree/results.json`
...
`plan/ws024-unified-ufs/temp/ws025-p021-release-driver-final`.
...
`plan/ws024-unified-ufs/temp/ws025-p021-release/results.json` and
...
`plan/ws024-unified-ufs/temp/ws025-p021-unlink/results.json` and
...
`plan/ws024-unified-ufs/temp/ws025-p021-link/results.json` and
...
`plan/ws024-unified-ufs/temp/ws025-p021-rmdir/results.json` and
...
`plan/ws024-unified-ufs/temp/ws025-p021-images/results.json` and
...
`plan/ws024-unified-ufs/temp/ws025-p021-rename/results.json` and
...
in `plan/ws024-unified-ufs/temp/ws025-p021-retire/results.json` and
...
in `plan/ws024-unified-ufs/temp/ws025-p021-xattr-release/results.json` and
...
PASS in `plan/ws024-unified-ufs/temp/ws025-p021-xattr-replace/results.json` and
...
PASS in `plan/ws024-unified-ufs/temp/ws025-p021-xattr-allocation/results.json` and
...
in `plan/ws024-unified-ufs/temp/ws025-p021-reserve/results.json` and
...
`plan/ws024-unified-ufs/temp/ws025-p021-cleanup/results.json` and
...
Native features/remount/reboot PASS in
`plan/ws024-unified-ufs/temp/ws025-p021-directory/results.json` with RUN 135 and
...
`plan/ws024-unified-ufs/temp/ws025-p021-creation/results.json`, RUN 135 / VERIFY 26
...
`plan/ws024-unified-ufs/temp/ws025-p021-orphan/results.json`, including explicit
...
PASS in `plan/ws024-unified-ufs/temp/ws025-p021-view/results.json`, RUN 135 /
...
- `plan/ws024-unified-ufs/temp/ws025-p021-deferred/results.json`: QEMU USB boot,
...
`plan/ws018-kernel-architecture/temp/ws025-p021-final/results.json` record FS50/50
