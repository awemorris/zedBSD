...
paths=['src/kern/'+s+'.c' for s in sources]+['plan/ws025-io-memory-cache/tests/exec-snapshot-vm-host.c','plan/ws025-io-memory-cache/tests/file-cache-host.c','plan/ws019-installation/tests/format-reservation-test.c','include/kern/io-destination.h','include/kern/file.h','include/kern/vm-object.h','include/kern/vmspace.h','include/kern/vm-reclaim.h','plan/ws025-io-memory-cache/tests/run-exec-snapshot-vm-host.py']
