...
sources=['src/kern/readahead.c','src/kern/readahead-worker.c','src/kern/io-scratch.c','src/kern/shutdown.c','plan/ws025-io-memory-cache/tests/readahead-worker-host.c']
