...
| 既存資料・fixture | 利用する範囲 |
| --- | --- |
| [UEFI normalizer fixture](../../ws003-bringup/tests/uefi-memory-map-test.c) | p002 の高位/型/overflow/予約の基準 |
| [BR-T24](../../ws003-bringup/tests/uefi-high-memory-usb-boot.sh) | firmware/RAM/USB boot の土台。高位 PFN 使用 oracle を追加して別結果にする |
| [q086 FS50 の実行器](../../ws018-kernel-architecture/tests/run-storage-acceptance.py) | native/overlay/FS 内容・永続化の回帰 |
| [q086 結果](../../ws018-kernel-architecture/phase019-storage-acceptance/results.md) | 既存の合格範囲と性能 baseline |
| [q087 Phase](../../ws018-kernel-architecture/phase020-syscall-request-batching/phase.md) | 六 syscall、vector/PIPE_BUF/partial の境界。fixture は実行時の最新 owner を確認 |
| [UFS metadata audit runner](../../ws018-kernel-architecture/tests/run-ufs-metadata-audit.sh) | allocation/publication/失敗を production 実装へ接続 |
| [FAT native VFS runner](../../ws018-kernel-architecture/tests/run-fat-native-vfs-host-test.sh) | FAT operation/loop coherence |
| [UFS2 consistency runner](../../ws018-kernel-architecture/tests/run-ufs2-consistency-host-test.sh) | WS024 移行後の journal/snapshot 等の継承確認 |
| [AX211 DMA runner](../../ws004-hardware/tests/run-intel-ax211-dma-test.sh) | 共通 DMA 修正の回帰。全 HCD/device の代わりにはしない |
