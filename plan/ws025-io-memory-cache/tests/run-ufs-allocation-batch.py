...
for variant in ('ordinary', 'sanitize'):
    ...
    subprocess.run(['cc', '-DZEDBSD_USER_ABI_LP64', '-O1', '-g', '-pthread',
        *extra, '-c', 'plan/ws018-kernel-architecture/tests/mount-thread-host.c',
    ...
    subprocess.run(['cc', '-DZEDBSD_USER_ABI_LP64', '-std=c11', '-O1', '-g',
        ...
        *extra, '-I.', '-Iinclude', '-Iinclude/uapi', '-Isrc', '-Ilibc/include',
        '-Iplan/ws018-kernel-architecture/tests', '-Iplan/ws025-io-memory-cache/temp/p031-driver-fragments/src/drivers/fs/ufs',
        'plan/ws025-io-memory-cache/tests/ufs-allocation-batch-host.c',
        'plan/ws025-io-memory-cache/temp/p031-driver-fragments/src/drivers/fs/ufs/ufs-endian.c', 'src/kern/quota.c', 'src/kern/io-stats.c',
