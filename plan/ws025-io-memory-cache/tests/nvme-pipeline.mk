...
$(WS025_NVME_OBJECT): plan/ws004-hardware/tests/nvme-io-guest.c $(ZEDBSD_SYSROOT_AMD64)/.zedbsd-sysroot-complete
	@mkdir -p $(dir $@)
...
$(WS025_NVME_BIO_OBJECT): plan/ws025-io-memory-cache/tests/nvme-pipeline-guest.c $(ZEDBSD_SYSROOT_AMD64)/.zedbsd-sysroot-complete
	@mkdir -p $(dir $@)
...
$(WS025_NVME_KERNEL): plan/ws025-io-memory-cache/tests/nvme-pipeline-kernel.c $(ZEDBSD_SYSROOT_AMD64)/.zedbsd-sysroot-complete
	@mkdir -p $(dir $@)
