...
temporary=$(mktemp -d "$repo/plan/ws025-io-memory-cache/temp/uas-descriptor.XXXXXX")
trap 'rm -rf -- "$temporary"' EXIT
sources=("$repo/src/drivers/usb/usb-uas.c" "$repo/plan/ws025-io-memory-cache/tests/uas-descriptor-host.c")
