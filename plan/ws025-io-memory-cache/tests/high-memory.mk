...
include plan/ws025-io-memory-cache/tests/io-baseline.mk
...
$(WS025_HIGH_KERNEL): plan/ws025-io-memory-cache/tests/high-memory-kernel.c $(ZEDBSD_SYSROOT_AMD64)/.zedbsd-sysroot-complete
	@mkdir -p $(dir $@)
