...
sources=['src/kern/mount.c','src/kern/inode.c','src/kern/namei.c','src/kern/namecache.c','src/kern/cwdinfo.c','plan/ws025-io-memory-cache/tests/writeback-unmount-vfs-host.c']
