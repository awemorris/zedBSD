...
for variant in ('ordinary','sanitize'):
 ...
 binary=out/variant
 args=['cc','-std=c11','-g','-Wall','-Wextra','-Werror','-Iinclude','-Iinclude/uapi','-I.',*flags,'plan/ws025-io-memory-cache/tests/dma-vector-host.c','src/drivers/dma.c','src/hal/amd64/pmem-range.c','src/kern/cache-memory.c','src/kern/io-stats.c','-pthread','-o',str(binary)]
