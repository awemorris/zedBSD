...
[review](../phase028-direct-user-io/hal-vmap-review.md) remains valid under the new
...
[Results](results.md). Additional allocation signature and SYS integration remain
in the [review proposal](../hal-interface-proposal.md); they are not covered by
