...
| --- | --- | --- | --- | --- |
| 1 | `ws003-p011` | [WS003](../ws003/ws.md), [Phase](../ws003/phase011/phase.md), [contract](../../docs/reference/kernel-boot-parameters.md) | completed | BR-T42 passes and one architecture-independent parser provides the complete name set plus exact `init=` selection/failure semantics |
| 2 | `ws003-p012` | [WS003](../ws003/ws.md), [Phase](../ws003/phase012/phase.md), [tests](../ws003/tests/README.md) | completed | BR-T43, all four production build/link paths, and amd64 BIOS/UEFI marker boots pass; PC/AT and PC-98 production runtime remains in p015 |
| 3 | `ws003-p013` | [WS003](../ws003/ws.md), [Phase](../ws003/phase013/phase.md), [contract](../../docs/reference/kernel-boot-parameters.md) | completed | BR-T44, build, and representative BIOS/UEFI overlay boots pass; the native-root and full four-platform runtime matrix remains in p015 |
| 4 | `ws003-p014` | [WS003](../ws003/ws.md), [Phase](../ws003/phase014/phase.md), [tests](../ws003/tests/README.md) | completed | BR-T45 passes; sparse `swap0`--`swap3` file/raw sources activate atomically as one ordered pool and retain existing `ZEDSWAP1` compatibility |
| 5 | `ws003-p015` | [WS003](../ws003/ws.md), [Phase](../ws003/phase015/phase.md), [tests](../ws003/tests/README.md) | completed | BR-T46 passes every required production-loader cell on i386 PC/AT, i386 PC-98, amd64 BIOS, and amd64 UEFI and promotes the public contract from planned to implemented status |
...
6. Complete p015 by adding a reusable BR-T46 harness under
   `plan/ws003/tests/`. It must preserve the user's `config.mk`, build
...
BR-T46 run is `plan/ws003/temp/q015-br-t46-final-007`: it ran from
...
[`ws004-p009`](../ws004/phase009/phase.md).
...
[`ws002-p021`](../ws002/phase021/phase.md)
