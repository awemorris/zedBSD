...
| --- | --- | --- | --- |
| 1 | [ws025-p029](../ws025/phase029/phase.md) | uncleared | Boot with an empty removable SCSI LUN, require class binding without disk publication, insert media and verify normal I/O at both speeds |
