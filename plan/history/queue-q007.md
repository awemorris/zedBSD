...
| --- | --- | --- | --- | --- | --- |
| 1 | USB boot/root continuity | `ws004-p005` | [WS004](../ws004/ws.md), [Phase](../ws004/phase005/phase.md), [tests](../ws004/tests/README.md) | uncleared | BIOS/UEFI identity and bounded discovery pass, but USB overlay writes and clean warm reboot do not |
...
- [`ws004-p006`](../ws004/phase006/phase.md) for USB
  loop-backed overlay writes; and
- [`ws004-p007`](../ws004/phase007/phase.md) for PC/AT warm
