...
| --- | --- | --- | --- | --- |
| 1 | `ws009-p004` | [Phase](../ws009/phase004/phase.md) | completed | The evdev reference states current per-source, character-only, overflow/resync, console-subscriber, and detach behavior without claiming live USB HID |
| 2 | `ws009-p005` | [Phase](../ws009/phase005/phase.md) | completed | Every common boot parameter, default, rejection rule, and four-x86-loader path matches production source and retained evidence |
