...
| --- | --- | --- | --- |
| 1 | [ws025-p021](../ws025/phase021/phase.md) | completed | Broaden deferred allocation/truncate/namespace fault injection, close CRASH/META/WB/FLUSH coverage, and run FS50/Wi-Fi30/native storage regression. Depends on q111–q115 verified ownership and opt-in checkpoint integration. |
