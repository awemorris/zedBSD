...
| --- | --- | --- | --- |
| 1 | [ws025-p028](../ws025/phase028/phase.md) | uncleared | Prefix-preserving coherent read API, forbid raw-buffer fallback, hostile backend/short/memory tests and supported builds |
