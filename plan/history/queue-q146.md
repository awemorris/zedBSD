...
| --- | --- | --- | --- |
| 1 | [ws006-p010](../ws006/phase010/phase.md) | uncleared | xHCI pre-GUI checks pass; paired replay not reached after GUI failure |
| 2 | [ws006-p009](../ws006/phase009/phase.md) | uncleared | Xzed/zterm starts and executes the typed tty command; libc rejects the PTY. Route correction to new p011 |
