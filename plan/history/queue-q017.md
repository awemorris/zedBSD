...
| --- | --- | --- | --- | --- |
| 1 | `ws012-p002` | [WS012](../ws012/ws.md), [Phase](../ws012/phase002/phase.md), [tests](../ws012/tests/README.md) | completed | All rc.conf readers use the strict YAML v1 model; stable locking and atomic replacement pass focused failure/concurrency fixtures and the production build |
...
[`ws003-p016`](../ws003/phase016/phase.md)
