...
| --- | --- | --- | --- |
| 1 | [ws025-p037](../ws025/phase037/phase.md) | uncleared | Remove request structure from physical allocation API, implementations and callers; focused allocation/VM checks and builds |
