...
| --- | --- | --- | --- |
| 1 | [`ws011-p007`](../ws011/phase007/phase.md) | uncleared (`q074`) | NCOM-T020 passed; NCOM-T021 stopped at the final-request/publication boundary before DISARM, late-deadline, and reboot evidence |
...
- Use restricted QEMU user networking, a fixed synthetic MAC, monitor-driven
  ...
  before/after digest.
- Retain reusable runner/config fixtures under `plan/ws011/tests/`.
...
- The bounded environment, hashes, and results are retained in the
  [q074 evidence summary](../ws011/tests/q074-confirmed-commit-qemu-evidence.md).
