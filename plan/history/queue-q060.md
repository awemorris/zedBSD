...
| --- | --- | --- | --- | --- |
| 1 | `ws004-p030` | [WLAN lifecycle hardening](../ws004/phase030/phase.md) | automatic milestone completed (`q060`); shared physical closure pending | P030's rekey/reconnect/lifecycle/fault/race/storage automatic milestone passes without claiming its later shared physical closure |
