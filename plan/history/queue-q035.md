...
| --- | --- | --- | --- | --- |
| 1 | `ws018-p009` | [Phase](../ws018/phase009/phase.md) | completed | Complete the remaining PC/AT VGA/Cirrus, PC-98 GDC/Cirrus, and graphics-disabled runtime matrix, or record the exact missing-runner boundary without changing the accepted UAPI |
| 2 | `ws018-p010` | [Phase](../ws018/phase010/phase.md) | completed | One `src/drivers/fs/fat.c` and one `include/kern/fat.h` preserve the measured legacy behavior |
| 3 | `ws018-p011` | [Phase](../ws018/phase011/phase.md) | completed | FAT uses ordinary filesystem/VFS objects for boot media, overlay images, and swap with no embedded bootfs adapter |
| 4 | `ws018-p012` | [Phase](../ws018/phase012/phase.md) | completed | Remove the now-unreferenced bootfs/namespace/startup/M9/internal state while preserving explicit `/dev/system` handoff ownership and four-platform boot |
