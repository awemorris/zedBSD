...
Archived Queue record: `plan/history/queue-q014.md`
...
| --- | --- | --- | --- | --- |
| 1 | `ws003-p010` | [WS003](../ws003/ws.md), [Phase](../ws003/phase010/phase.md), [evidence](../ws003/tests/latitude-xhci-evidence.md) | completed | BR-T41 passes: the USB-backed writable overlay, init/login, root shell, and X/`zterm` are reached without the opcode-35 failure |
