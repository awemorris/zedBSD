...
| --- | --- | --- | --- |
| 1 | [ws025-p028](../ws025/phase028/phase.md) | uncleared | Repair current-source VM/PTE fixture wiring; exercise real mutators with held lease, refault/COW and lifetime cleanup; fix discovered in-scope faults |
