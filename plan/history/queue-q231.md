...
| --- | --- | --- | --- |
| 1 | [ws025-p028](../ws025/phase028/phase.md) | uncleared | Reconnect actual vmap/scratch fixture to merged io.c; verify ownership/rollback baseline before borrowed-frame implementation |
