...
Successor note: `q029` supersedes q028's then-current p019-before-p001
sequencing. The completed q028 association/publication result is unchanged.
...
| --- | --- | --- | --- | --- |
| 1 | `ws004-p018` | [Phase](../ws004/phase018/phase.md) | completed | Union-associated, IAD-less NCM wins a three-configuration RTL8156-shaped fixture, binding diagnostics are actionable, automatic/build/QEMU gates pass, and Latitude publishes `ue0` |
...
[`ws005-p001`](../ws005/phase001/phase.md);
q028 does not claim carrier, DHCP, or data transfer. Before that physical Phase
is queued, [`ws004-p019`](../ws004/phase019/phase.md)
