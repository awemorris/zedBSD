...
| --- | --- | --- | --- |
| 1 | [ws018-p016](../ws018/phase016/phase.md) | completed | Import refactored kern while preserving current storage, filesystem, VM, swap and WLAN fixes; verify host/build/boot behavior |
...
See [q084 results](../ws018/tests/q084-results.md) for provenance,
