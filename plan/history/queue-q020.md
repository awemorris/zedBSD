...
| --- | --- | --- | --- | --- |
| 1 | `ws006-p005` | [WS006](../ws006/ws.md), [Phase](../ws006/phase005/phase.md), [tests](../ws006/tests/README.md) | complete | Production evdev reports registered type/code capabilities, current key/button state, and ABS metadata/state, and a guest discovers keyboard/pointer roles without numbers or names |
| 2 | `ws008-p002` | [WS008](../ws008/ws.md), [Phase](../ws008/phase002/phase.md), [tests](../ws008/tests/README.md) | complete | Canonical BeUI uses `/dev/graphics` and capability-discovered evdev, the downstream duplicate is removed, and host/QEMU backend evidence passes |
| 3 | `ws008-p003` | [WS008](../ws008/ws.md), [Phase](../ws008/phase003/phase.md), [tests](../ws008/tests/README.md) | complete | Direct VM and canonical Noct probes prove generated amd64 code executes after RW-to-RX protection with no accepted fallback or RWX mapping |
...
1. Execute [ws006-p005](../ws006/phase005/phase.md):
...
2. On p005 completion, resume
   [ws008-p002](../ws008/phase002/phase.md) from its recorded
   q019 stop point and complete canonical graphics/evdev migration and tests.
3. On p002 completion, execute
   [ws008-p003](../ws008/phase003/phase.md) and prove direct and
