...
| --- | --- | --- | --- |
| 1 | [ws025-p029](../ws025/phase029/phase.md) | uncleared | Throttle only disposable UAS backing, force a read timeout, remove delay and require a new read plus captured distinct-tag ABORT TASK/Response; fix demonstrated defects |
