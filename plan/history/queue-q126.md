...
| --- | --- | --- | --- |
| 1 | [ws006-p009](../ws006/phase009/phase.md) | uncleared | 不使用console event UAPIと専用queue/ownerを削除し、TTY broker・evdev consumer・通常起動を検証する。 |
...
結果: [p009 results](../ws006/phase009/results.md)。実装・通常ビルド・主要host/QEMUはPASS、paired USB root列挙とXzed GUI確認を残す。
