...
| --- | --- | --- | --- | --- |
| 1 | `ws004-p038` | [standalone Intel AX211 normal path](../ws004/phase038/phase.md) | uncleared (`q062`); physical checkpoint deferred by the user | Exact AX211/CNVio2 attach and pinned firmware/PNVM pass automatic gates; one direct exact-device scan/WPA2/CCMP/DHCP/ping/fetch/disconnect/down checkpoint remains pending without blocking the next Queue |
