...
| --- | --- | --- | --- |
| 1 | [ws004-p046](../ws004/phase046/phase.md) | uncleared | Both bands pass authentication, DHCP, ping, HTTP and down in cell 4; only the final post-5-GHz reopen remains for q082 |
...
Record [q081 evidence](../ws004/tests/q081-results.md), synchronize
