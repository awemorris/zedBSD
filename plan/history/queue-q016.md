...
| --- | --- | --- | --- | --- |
| 1 | `ws004-p009` | [WS004](../ws004/ws.md), [Phase](../ws004/phase009/phase.md), [tests](../ws004/tests/README.md) | complete | EHCI and UHCI retain all ownership on checked IRQ removal failure, retry safely, pass focused lifecycle tests, and build for i386 PC/AT and PC-98 |
