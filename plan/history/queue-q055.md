...
| --- | --- | --- | --- | --- |
| 1 | `ws004-p026` | [Phase](../ws004/phase026/phase.md) | completed | Japan label, absent revision marking, exact retained descriptor authority, and optional hash-verified GitHub firmware-package boundary are synchronized |
| 2 | `ws004-p027` | [Phase](../ws004/phase027/phase.md) | completed | Versioned WLAN ioctl ABI, active-ioctl lifetime gate, persistent common station state, bounded cache/generations, and deterministic fake radio pass every automatic gate |
