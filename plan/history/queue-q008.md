...
| --- | --- | --- | --- | --- | --- |
| 1 | Latitude USB UEFI loader halts around final memory-map/boot-services exit | `ws003-p002` | [WS003](../ws003/ws.md), [Phase](../ws003/phase002/phase.md), [WS003 tests](../ws003/tests/README.md) | uncleared | Software sequencing correction and OVMF control pass; three Latitude cold boots remain human-operated acceptance work |
| 2 | USB `loop1` overlay writes intermittently return `EIO` during startup/login | `ws004-p006` | [WS004](../ws004/ws.md), [Phase](../ws004/phase006/phase.md), [HW-T12](../ws004/tests/README.md) | uncleared | Leading URB publication-race hypothesis and 1,000-boot gate are carried into `q009` as its sole item |
| 3 | Warm reboot enters the second kernel with stale allocator BSS state | `ws004-p007` | [WS004](../ws004/ws.md), [Phase](../ws004/phase007/phase.md), [HW-T13](../ws004/tests/README.md) | completed | Native-mode ELF64 BSS clearing passes three consecutive IDE reboots and a combined USB reboot |
