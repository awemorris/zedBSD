...
| --- | --- | --- | --- | --- |
| 1 | `ws004-p021` | [Phase](../ws004/phase021/phase.md) | uncleared | Current-source focused/regression/configured-build gates and one fresh OVMF q35+xHCI USB-root boot pass; retain one hash-pinned candidate for the still-required Latitude `ue0` checkpoint |
