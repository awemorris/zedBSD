...
| --- | --- | --- | --- | --- |
| 1 | `ws001-p015` | [Canonical Phase](../ws001/phase022/phase.md) | uncleared | Source/host milestone passes: atomic authorization/credential snapshot, all creation callers/backends, conservative rollback, 50 request checks, AF_UNIX publication, 883,564 FAT ordinary/sanitized checks, and UFS gates; two backend fault cells plus native/remount evidence remain |
| 2 | `ws001-p016` | [Canonical Phase](../ws001/phase023/phase.md) | uncleared | Source implementation and 135 deterministic ordering/error checks pass; disposable-image remount and device-flush acceptance cannot run until `ws008-p010` restores Noct `--path` |
| 3 | `ws005-p005` | [Phase](../ws005/phase005/phase.md) | uncleared | Its retained host implementation was not rerun as invalid native acceptance: both explicit WS001 prerequisites remain incomplete |
