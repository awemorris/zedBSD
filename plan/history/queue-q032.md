...
| --- | --- | --- | --- | --- |
| 1 | `ws013-p005` | [Phase](../ws013/phase005/phase.md) | completed | i386 PC/AT and amd64 BIOS reach payload PBR -> `BOOTZBSD.EXE` -> `/zedbsd.cfg`; one amd64 hybrid image shares its payload configuration with UEFI |
| 2 | `ws013-p006` | [Phase](../ws013/phase006/phase.md) | completed | PC-98 `BOOTZBSD.EXE` consumes `/BOOTZBSD.CFG` with exact p003 behavior and boots overlay/native roots |
