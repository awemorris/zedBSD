...
| --- | --- | --- | --- |
| 1 | [ws019-p035](../ws019/phase035/phase.md) | completed | Reserved mkfs, native FAT mount/copy/remount, shell cp repair, host regressions and three builds pass |
...
Previous codec results: [p034 acceptance](../ws019/phase034/results.md).

Accepted: [p035 results](../ws019/phase035/results.md).
