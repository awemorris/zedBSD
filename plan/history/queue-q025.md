...
| --- | --- | --- | --- | --- |
| 1 | `ws008-p007` | [Phase](../ws008/phase007/phase.md) | completed | Target Noct and dependent Remacs are unavailable to image selection while host Noct scripting remains operational |
| 2 | `ws018-p001` | [Phase](../ws018/phase001/phase.md) | completed | Move repository-root drivers to `src/drivers/` and repair every maintained build/test path without behavior change |
| 3 | `ws018-p005` | [Phase](../ws018/phase005/phase.md) | completed | Merge exec preparation into `exec.c` and delete only proven-dead image code |
| 4 | `ws018-p006` | [Phase](../ws018/phase006/phase.md) | completed | Consolidate boot implementation and public declarations into one stable `boot.c`/`boot.h` contract |
| 5 | `ws018-p003` | [Phase](../ws018/phase003/phase.md) | completed | Make UFS1 and UFS2 independent filesystem implementations without a common implementation directory |
| 6 | `ws018-p004` | [Phase](../ws018/phase004/phase.md) | completed | Move filesystem recognition behind the filesystem-driver identity callback while generic identities remain generic |
