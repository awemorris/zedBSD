...
| --- | --- | --- | --- | --- |
| 1 | `ws005-p002` | [Phase](../ws005/phase002/phase.md) | completed | All dependent P-books carry the frozen v1 bounds and ownership; superseded `/sbin/wpa` work remains explicitly historical |
