...
| --- | --- | --- | --- |
| 1 | [ws025-p028](../ws025/phase028/phase.md) | uncleared | Bounded pin-vector deduplication, all-alias reservation, synchronous PTE revoke, rollback/release fixture and supported builds |
