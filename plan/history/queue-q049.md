...
| --- | --- | --- | --- | --- |
| 1 | `ws004-p019` | [Phase](../ws004/phase019/phase.md) | completed | Independent CDC ECM selects QEMU's standards configuration, publishes `ue0`, passes static and DHCP traffic plus detach/reconnect, honors the zero-packet HCD contract, and passes all four IDE/xHCI-storage QEMU cells |
