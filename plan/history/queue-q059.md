...
| --- | --- | --- | --- | --- |
| 1 | `ws005-p004` | [Primitive wifi command](../ws005/phase004/phase.md) | completed (`q059`) | The direct root `/sbin/wifi` human command drives the existing scan/status/connect/disconnect WLAN ioctls on the normal path |
| 2 | `ws005-p009` | [Minimum connectivity](../ws005/phase009/phase.md) | completed (`q059`) | One physical adapter run reaches scan, secure carrier, DHCP, ping, and bounded fetch using runtime-only credentials |
