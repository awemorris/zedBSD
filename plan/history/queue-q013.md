...
| --- | --- | --- | --- | --- |
| 1 | `ws003-p007` | [WS003](../ws003/ws.md), [Phase](../ws003/phase007/phase.md), [evidence](../ws003/tests/latitude-xhci-evidence.md) | completed | BR-T36 passed and BR-T34 exercised both physical xHCI controllers without DMA-registry failure |
| 2 | `ws003-p008` | [WS003](../ws003/ws.md), [Phase](../ws003/phase008/phase.md), [evidence](../ws003/tests/latitude-xhci-evidence.md) | completed | BR-T37 passed and BR-T34 configured multiple devices and registered the intended storage object |
| 3 | `ws003-p005` | [WS003](../ws003/ws.md), [Phase](../ws003/phase005/phase.md), [evidence](../ws003/tests/latitude-xhci-evidence.md) | completed | BR-T28/BR-T29 passed; BR-T34 showed no command/cancel/retained-DMA failure |
| 4 | `ws003-p006` | [WS003](../ws003/ws.md), [Phase](../ws003/phase006/phase.md), [evidence](../ws003/tests/latitude-xhci-evidence.md) | completed | BR-T35 passed and BR-T34 reached BOT/SCSI through working bulk endpoints |
| 5 | `ws003-p009` | [WS003](../ws003/ws.md), [Phase](../ws003/phase009/phase.md), [evidence](../ws003/tests/latitude-xhci-evidence.md) | completed | BR-T38 passed and the SuperSpeed boot medium configured and registered as `sda` |
| 6 | `ws003-p004` | [WS003](../ws003/ws.md), [Phase](../ws003/phase004/phase.md), [evidence](../ws003/tests/latitude-xhci-evidence.md) | completed | BR-T34 reached `usb-storage: sda`; U2 passed and the later U3 SCSI flush stop was extracted |
