...
| --- | --- | --- | --- |
| 1 | [ws019-p005](../ws019/phase005/phase.md) | completed | NVMe-only boot/persistence, selection and 12 fault-model runs; q160 consolidated acceptance passed |

Execute the [q160 design](../ws019/phase005/q160-design.md).
