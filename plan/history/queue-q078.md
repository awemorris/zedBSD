...
| --- | --- | --- | --- |
| 1 | [ws019-p008](../ws019/phase008/phase.md) | uncleared | Implement target UFS1-in-file initializer and its descriptor reservation; p002 and q077 filesystem gates complete |
| 2 | [ws019-p009](../ws019/phase009/phase.md) | uncleared | Implement production ZEDSWAP2-in-file initializer using the same reservation; no installer template |
...
[Detailed q078 evidence](../ws019/tests/q078-results.md).
