...
| --- | --- | --- | --- |
| 1 | [ws025-p014](../ws025/phase014/phase.md) | completed | Track accepted/completed/stable writes, preserve upper drain and merge only proven repeated physical flushes. Requires completed p001. |
...
Result: [p014 results](../ws025/phase014/results.md); all selected gates passed.
