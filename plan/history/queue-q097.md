...
| --- | --- | --- | --- |
| 1 | [ws025-p010](../ws025/phase010/phase.md) | completed | Introduce immediate allocation adapter and bounded CG/indirect cache reuse. Requires completed p008. |
...
Result: [p010 results](../ws025/phase010/results.md). All selected gates passed.
