...
| --- | --- | --- | --- | --- |
| 1 | `ws016-p001` | [WS016](../ws016/ws.md), [Phase](../ws016/phase001/phase.md), [tests](../ws016/tests/README.md) | complete | Stable source-encoded slots, dynamic add/drain/remove, backing claims, and live commit accounting pass focused host tests and regressions |
| 2 | `ws016-p002` | [WS016](../ws016/ws.md), [Phase](../ws016/phase002/phase.md), [tests](../ws016/tests/README.md) | complete | Versioned privileged `/dev/system` control and source enumeration pass ABI, permission, and failure-atomicity tests |
| 3 | `ws016-p003` | [WS016](../ws016/ws.md), [Phase](../ws016/phase003/phase.md), [tests](../ws016/tests/README.md) | complete | `/sbin/swapon` and `/sbin/swapoff` implement the fixed multi-operand CLI and are installed in configured images |
| 4 | `ws016-p004` | [WS016](../ws016/ws.md), [Phase](../ws016/phase004/phase.md), [tests](../ws016/tests/README.md) | complete | Disposable amd64 QEMU images prove runtime add, page-out/in, safe installed-command drain/remove, failure preservation, ID reuse, and boot-swap regression |
...
Finished on 2026-08-28 with all four WS016 Phases complete. SWAP-T001--T012,
focused VM/storage/UAPI/command regressions, and `make -j16` passed. The final
p004 disposable amd64 UEFI acceptance passed 6/6 runtime and representative
BR-T46 cells; its result-table SHA-256 is
`94c36cc82625d8150db69269df50d02a03ba8e0f1233f4a4cdcb284b3ed07f14`.
The successor Queue is proposed separately in `queue.md`; its implementation
requires its own execution approval.
