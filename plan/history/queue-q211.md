...
| --- | --- | --- | --- |
| 1 | [ws025-p029](../ws025/phase029/phase.md) | uncleared | Delay one backend write beyond transport deadline, verify timeout/recovery and sticky write/fsync failure without replay |
