...
| --- | --- | --- | --- |
| 1 | [ws024-p002](../ws024/phase002/phase.md) | completed | One 64-bit driver/registration, checked width boundaries, preserved features. Requires completed p001. |
| 2 | [ws024-p003](../ws024/phase003/phase.md) | completed | Switch target/host formatters and every image/root consumer to the same frozen profile. Requires p002 integration interface. |

Execute the [frozen contract](../ws024/format-contract.md). Carry WS025
