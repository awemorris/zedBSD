...
| --- | --- | --- | --- | --- |
| 1 | `ws004-p017` | [Phase](../ws004/phase017/phase.md) | completed | Locked common error accounting plus exactly-once NCM terminal completion and orderly-cancel behavior pass focused, sanitizer, analyzer, build, and USB-root QEMU regressions |
