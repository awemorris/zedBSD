...
| --- | --- | --- | --- | --- |
| 1 | `ws001-p021` | [Phase](../ws001/phase021/phase.md) | completed | Enforce the clarified control-block symmetry, loop bracing, entry indentation, and entry-spacing rules across all 214 implementations |
