...
| --- | --- | --- | --- |
| 1 | [ws025-p028](../ws025/phase028/phase.md) | uncleared | Explicit borrowed RAM vmap ownership, readonly/write permissions, rollback/retirement tests, three supported builds |
