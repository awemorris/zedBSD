...
| --- | --- | --- | --- |
| 1 | [ws018-p013](../ws018/phase013/phase.md) | completed | Remove proven-unused synthetic rootfs, inode-only mount APIs/marker and six manifest references; preserve current mount/boot behavior |
| 1a | [ws018-p014](../ws018/phase014/phase.md) | completed | Audit and fix covered-directory mutation, aliases and namespace lifetime/transaction races; prerequisite for p013 protection gate and storage runtime |
| 1b | [ws018-p015](../ws018/phase015/phase.md) | completed | Filesystem-wide risk audit: core/driver/I/O/lifetime/permission boundaries, test coverage and explicit residual findings |
| 2 | [ws019-p010](../ws019/phase010/phase.md) | completed | Validation only: explicit ro/rw/root EBUSY and reboot; depends on p013 host/build gates |
| 3 | [ws019-p011](../ws019/phase011/phase.md) | completed | Validation only: mounted addition persists, exits 3, no live replacement, reboot discovers child |
| 4 | [ws019-p012](../ws019/phase012/phase.md) | completed | Validation only: explicit mounts work; no automatic auxiliary mounts before/after reboot |
...
is selected at `plan/ws019/temp/q077-resume-01`, with
...
All selected Phases completed. [Q077 evidence](../ws018/tests/q077-results.md)
