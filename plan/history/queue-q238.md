...
| --- | --- | --- | --- |
| 1 | [ws025-p028](../ws025/phase028/phase.md) | uncleared | Disposable QEMU baseline/experimental input-view write/pwrite, append/limit/fsync/readback and counters/CPU comparison; fix demonstrated in-scope failures |
