...
| --- | --- | --- | --- | --- |
| 1 | `ws003-p022` | [Phase](../ws003/phase022/phase.md) | uncleared | All automatic source/binary/layout, build, and qemu-pc98 login gates pass; exact frozen image awaits the already-requested PC-9821V13 observation |
