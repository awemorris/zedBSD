# Queue q023: static boot defaults, independent BeUI backends, and shell TTY ordering
...
| --- | --- | --- | --- | --- |
| 1 | `ws003-p016` | [WS003](../ws003/ws.md), [Phase](../ws003/phase016/phase.md), [tests](../ws003/tests/README.md) | completed | One maintained source default feeds every x86 loader and kernel fallback; generated/Python inputs disappear and affected four-platform and swap evidence remains usable |
| 2 | `ws008-p005` | [WS008](../ws008/ws.md), [Phase](../ws008/phase005/phase.md), [tests](../ws008/tests/README.md) | completed | Each selected canonical BeUI platform source independently implements the sole public `noct_register_api_beui()` interface; shared dispatcher/backend and public HAL injection disappear |
| 3 | `ws001-p014` | [WS001](../ws001/ws.md), [Phase](../ws001/phase014/phase.md), [tests](../ws001/tests/README.md) | completed | Foreground pipeline children cannot read before TTY handoff, and `fg` foregrounds before `SIGCONT`, without background/non-TTY regression |
...
- `ws003-p016` completed on 2026-08-28. `BR-T47a/b` passed at
  `plan/ws003/temp/q023-p016-audit-final.8oHUQf`; the authoritative
  four-path matrix passed 31/31 at
  `plan/ws003/temp/q023-p016-br-t46-authoritative.9rIQrm`; and the
...
- `ws008-p005` completed on 2026-08-28. Canonical NoctLang commit
  ...
  `plan/ws008/temp/q023-p005-backends.P8ZsxV`; canonical generic/SDL2/
  PC-98 tests passed; and `NOCT-T044` passed at
  `plan/ws008/temp/q020-p002-beui.unH7qL`. Non-JIT and JIT QEMU
...
- `ws001-p014` completed on 2026-08-28. The deterministic host fixture passed
  ...
  `plan/ws001/temp/q023-p014-job-control.LdD3qT`; an injected first
  ...
  `plan/ws001/temp/q023-p014-qemu.PhJyEq`; strict marker counts distinguish
