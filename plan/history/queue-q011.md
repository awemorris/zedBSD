...
| --- | --- | --- | --- | --- |
| 1 | `ws003-p002` | [WS003](../ws003/ws.md), [Phase](../ws003/phase002/phase.md), [BR-T32 evidence](../ws003/tests/latitude-uefi-evidence.md) | completed | Four physical GOP markers identify the old 1-GiB RSDP rejection; the bounded correction passes 4/8/16-GiB OVMF USB boots and BR-T32 passes 3/3 on the Latitude |
...
- Downstream handoff: both xHCI functions fail at `capabilities (13)`, followed
  ...
  are in [ws003-p003](../ws003/phase003/phase.md)
