...
| --- | --- | --- | --- |
| 1 | [ws025-p029](../ws025/phase029/phase.md) | uncleared | Connect high-speed command state to four preallocated synchronous endpoint URBs, bounded shared deadline, terminal failure admission, and checked teardown; focused host ownership/sequence tests and supported builds |
