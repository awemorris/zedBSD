...
Archived after q034 authorization: 2026-08-30
...
| --- | --- | --- | --- | --- |
| 1 | `ws003-p020` | [Phase](../ws003/phase020/phase.md) | completed | Early exceptions and ACPI/APIC/timer boundaries are observable; invalid APIC mode changes and unbounded PIT waits are removed; automated regressions and the single CF-SV7 observation pass |
...
Evidence is preserved under `plan/ws003/temp/q033-final/`. The
...
extracted as [ws003-p021](../ws003/phase021/phase.md)
