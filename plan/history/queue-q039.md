...
| --- | --- | --- | --- | --- |
| 1 | `ws003-p023` | [Phase](../ws003/phase023/phase.md) | uncleared | Automatic signature, corruption, normal-login, and diagnostic-login gates pass; one exact hashed image awaits one V13 audio observation |
| 2 | `ws007-p003` | [Phase](../ws007/phase003/phase.md) | complete | Slave IRQ lifecycle preserves PC-98 master IRQ7 cascade; production QEMU moves Xzed exactly `+100,+50` through evdev without manual PIC repair |
