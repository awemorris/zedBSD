...
| --- | --- | --- | --- | --- |
| 1 | `ws004-p042` | [RTL8822BU 2.4-GHz connect reproduction](../ws004/phase042/phase.md) | completed | The single exact channel-1 attempt reached generation 2, authorized connection, and zero-error status; the user's `ENOENT` did not reproduce |
...
[q069 evidence](../ws004/tests/q069-rtl8822bu-24ghz-evidence.md). The
