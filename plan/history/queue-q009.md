...
| --- | --- | --- | --- | --- |
| 1 | `ws004-p006` | [WS004](../ws004/ws.md), [Phase](../ws004/phase006/phase.md), [HW-T12](../ws004/tests/README.md) | uncleared | URB publication/lifecycle correction passes focused checks; the 1,000-boot gate is blocked by a separately planned SMP heap fault |
