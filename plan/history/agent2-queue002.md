...
| --- | --- | --- | --- | --- |
| 1 | `ws001-p019` | [Phase](../ws001/phase019/phase.md) | completed | All 269 `.c`, `.h`, and `.S` files below `userland` start with the canonical section 13 block and a separate useful file explanation, with implementation bodies preserved |
