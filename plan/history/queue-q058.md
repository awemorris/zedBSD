...
| --- | --- | --- | --- | --- |
| 1 | `ws004-p029` | [Phase](../ws004/phase029/phase.md) | automatic milestone completed | Strict WPA2-Personal/CCMP handshake, transactional RTL keys, controlled port, and bidirectional synthetic Ethernet L2 pass every automatic gate |
