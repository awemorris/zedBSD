...
Archived after completion as `queue-q064.md`.
...
| --- | --- | --- | --- | --- |
| 1 | `ws021-p001` | [LLVM source and zedBSD target](../ws021/phase001/phase.md) | complete (`q064`) | Verified LLVM 23.1.0 source intake and strict zedBSD triple/driver/compiler-rt patch |
| 2 | `ws021-p002` | [host LLVM build](../ws021/phase002/phase.md) | complete (`q064`) | Config-free `make toolchain` installs the required X86 Clang/LLD/LLVM tools below `build/llvm/` |
| 3 | `ws021-p007` | [host LLVM release asset](../ws021/phase007/phase.md) | complete (`q064`) | A validated x86_64 Linux host-tool archive is retained on `rev-0` and CI consumes its pinned digest |
| 4 | `ws021-p003` | [x86 sysroots](../ws021/phase003/phase.md) | complete (`q064`) | Deterministic amd64 and shared i386 public sysroots contain startup, libc, compiler runtime, and linker inputs |
| 5 | `ws021-p004` | [x86 target migration](../ws021/phase004/phase.md) | complete (`q064`) | All x86 kernels/userland, including target Noct, use the project LLVM tools and sysroots |
| 6 | `ws021-p005` | [bootloader closure](../ws021/phase005/phase.md) | complete (`q064`) | BIOS/UEFI loaders and all x86 images build without host target GNU/MinGW tools |
| 7 | `ws021-p006` | [big-bang QEMU acceptance](../ws021/phase006/phase.md) | complete (`q064`) | The final six-cell amd64/i386/PC-98 runtime campaign passes, including target Noct non-JIT/JIT/BeUI |
