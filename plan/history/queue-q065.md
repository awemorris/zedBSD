...
| --- | --- | --- | --- | --- |
| 1 | `ws004-p038` | [standalone AX211 normal path](../ws004/phase038/phase.md) | uncleared (`q065`) | Safe VFIO assignment on `10.0.10.25`, bounded QEMU hardware execution with exact-stage evidence, and verified host-driver restoration; retain one direct-boot result as the final Phase closure |
