...
| --- | --- | --- | --- |
| 1 | [ws024-p004](../ws024/phase004/phase.md) | completed | Complete consolidated feature, active-fixture, platform and boot gates; remove old production codecs. Requires completed q101 p002/p003. |
...
`ws024/temp/p004-active-retirement-inventory.json` (55 code/recipe files;
