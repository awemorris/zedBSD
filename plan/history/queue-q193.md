...
| --- | --- | --- | --- |
| 1 | [ws025-p029](../ws025/phase029/phase.md) | uncleared | Bind high-speed UAS endpoints, probe LUN 0 and flush policy, publish disk BIO owner with checked detach; fix variable-length SCSI response handling; build and attempt QEMU disk I/O |
