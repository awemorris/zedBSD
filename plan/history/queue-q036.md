...
| --- | --- | --- | --- | --- |
| 1 | `ws020-p001` | [Phase](../ws020/phase001/phase.md) | completed (revised) | Generic board-owned Variant and three-way artifact invariance pass; the withdrawn capacity field is absent |
| 2 | `ws020-p002` | [Phase](../ws020/phase002/phase.md) | completed (revised) | Combined, BIOS-only, and fixed pure-Protective-MBR UEFI-only layouts pass strict image/GPT gates |
| 3 | `ws020-p003` | [Phase](../ws020/phase003/phase.md) | uncleared | Maintained six-cell runner and strict positive/negative oracles are complete, but three fresh runs exposed a pre-existing intermittent init/getty stall after storage, root overlay, and swap succeeded |
