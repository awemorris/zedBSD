...
| --- | --- | --- | --- | --- |
| 1 | `ws008-p001` | [WS008](../ws008/ws.md), [Phase](../ws008/phase001/phase.md), [tests](../ws008/tests/README.md) | complete | `cmake --preset zedbsd` and its build preset produce the static canonical amd64 zedBSD Noct artifact, the package installs that artifact, and a non-JIT QEMU smoke passes |
| 2 | `ws008-p002` | [WS008](../ws008/ws.md), [Phase](../ws008/phase002/phase.md), [tests](../ws008/tests/README.md) | uncleared | Canonical BeUI uses `/dev/graphics` and capability-discovered evdev, the downstream duplicate is removed, and host/QEMU backend evidence passes |
| 3 | `ws008-p003` | [WS008](../ws008/ws.md), [Phase](../ws008/phase003/phase.md), [tests](../ws008/tests/README.md) | uncleared | Not executed: p002 did not complete, so the Queue dependency gate forbids starting p003 |
...
1. Execute [p001](../ws008/phase001/phase.md): preserve the
...
2. If p001 completes, execute
   [p002](../ws008/phase002/phase.md): move the zedBSD BeUI HAL to
...
3. If p002 completes, execute
   [p003](../ws008/phase003/phase.md): prove the VM transition with
...
repair is [`ws006-p005`](../ws006/phase005/phase.md);
