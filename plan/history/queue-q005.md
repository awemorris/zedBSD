...
| --- | --- | --- | --- | --- | --- |
| 1 | Physical-key input broker and guest evidence | `ws006-p004` | [WS006](../ws006/ws.md), [Phase](../ws006/phase004/phase.md), [tests](../ws006/tests/README.md) | completed | PC/AT software milestone: fixed string API, focused/build checks, and production QEMU evdev/console coexistence pass |
