...
| --- | --- | --- | --- | --- |
| 1 | `ws005-p005` | [Phase](../ws005/phase005/phase.md) | completed | Root, sudo-like, and ordinary-user stores pass ownership, atomicity, redaction, abrupt-stop, and second-boot persistence acceptance through the real `/sbin/net` |
