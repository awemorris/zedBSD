...
| --- | --- | --- | --- |
| 1 | [ws004-p050](../ws004/phase050/phase.md) | completed | Replace controller singleton and hard-coded namespace controller index; preserve per-controller lifecycle; QEMU discovery and installed boot in both enumeration orders |
