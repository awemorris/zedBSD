...
| --- | --- | --- | --- | --- |
| 1 | `ws004-p028` | [Phase](../ws004/phase028/phase.md) | automatic milestone completed | Licensed table import, minimum safe radio start, bounded software scan, and complete production-path synthetic results pass all automatic gates |
