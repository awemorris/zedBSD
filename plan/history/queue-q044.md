...
| --- | --- | --- | --- | --- |
| 1 | `ws006-p007` | [Phase](../ws006/phase007/phase.md) | completed | The bounded parser, including unsupported-field width validation, passes strict, ASan/UBSan, and analyzer fixtures at 791 checks without public UAPI change |
| 2 | `ws006-p006` | [Phase](../ws006/phase006/phase.md) | completed | Per-source state, bounded console subscription, transactional overflow resync, and callback/register/unregister ownership pass the focused automatic/source milestone |
