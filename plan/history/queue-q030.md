...
Archived after completion; the active Queue Book is [q031](../queue.md).
...
| --- | --- | --- | --- | --- |
| 1 | `ws004-p022` | [Phase](../ws004/phase022/phase.md) | completed | Standard PCI NVMe reset/admin queues/Identify publish exactly one truthful discovery-only `/dev/nvme0n1`; focused, build, QEMU, IDE, and USB gates pass |
| 2 | `ws004-p023` | [Phase](../ws004/phase023/phase.md) | completed | One bounded I/O queue provides read/write/flush and safe timeout/reset/shutdown/detach; focused/build/QEMU/IDE/USB gates pass |
| 3 | `ws004-p024` | [Phase](../ws004/phase024/phase.md) | completed | Disposable QEMU integrity/lifecycle and strict primary/backup GPT partition gates pass |

Final result: p022 through p024 completed on 2026-08-30. The retained
[I/O evidence](../ws004/tests/q030-nvme-io-evidence.md) and
[strict-GPT evidence](../ws004/tests/q030-nvme-gpt-evidence.md) cover
