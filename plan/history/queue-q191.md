...
| --- | --- | --- | --- |
| 1 | [ws025-p029](../ws025/phase029/phase.md) | uncleared | Implement bounded command IU encoding and high-speed READY/data/status state transitions, validate actual QEMU wire layout with focused production-code tests |
