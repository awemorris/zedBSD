...
| --- | --- | --- | --- | --- |
| 1 | `ws004-p036` | [Phase](../ws004/phase036/phase.md) | completed | Optional pinned firmware package plus exact USB/board/firmware/RX/lifecycle substrate passes every automatic gate while production refuses tableless radio start |
