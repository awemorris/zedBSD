...
| --- | --- | --- | --- | --- | --- |
| 1 | xHCI host controller | `ws004-p004` | [WS004](../ws004/ws.md), [Phase](../ws004/phase004/phase.md), [tests](../ws004/tests/README.md) | completed | QEMU storage milestone: production MSI-X xHCI storage enumeration, media read, and reconnect pass |
