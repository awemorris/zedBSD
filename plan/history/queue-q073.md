...
| --- | --- | --- | --- |
| 1 | [`ws011-p006`](../ws011/phase006/phase.md) | completed (`q073`) | Replaced interactive `apply`/`save`/`discard` with `commit`, `commit confirmed MINUTES`, and `rollback`; complete reconcile, volatile rollback ownership, and serialized publication gates pass |
