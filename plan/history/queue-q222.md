...
| --- | --- | --- | --- |
| 1 | [ws025-p029](../ws025/phase029/phase.md) | uncleared | Add non-destructive VM ownership check for revoked mount; reject mapping, pin, operation and orphan owners; verify actual file-cache fixture |
