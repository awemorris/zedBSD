...
| --- | --- | --- | --- |
| 1 | [ws025-p029](../ws025/phase029/phase.md) | uncleared | Validate retained VM file references before discard; expose deduplicated mount/inode internal refs; focused tests and builds |
