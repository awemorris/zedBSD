...
| --- | --- | --- | --- | --- |
| 1 | `ws008-p006` | [WS008](../ws008/ws.md), [Phase](../ws008/phase006/phase.md), [tests](../ws008/tests/README.md) | uncleared after maintainer review | Automated gates passed, but the Principal Engineer rejected the implementation quality during the first manual source review; the maintainer has taken ownership of the repair |
...
- One first QEMU non-JIT attempt encountered a pre-Noct IDE overlay-data EIO;
  ...
  retained in the [Phase evidence](../ws008/phase006/evidence.md).
