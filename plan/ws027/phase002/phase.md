<!-- awesome-plan project=zedbsd record=ws027-p002 -->

# ws027-p002: zedboot.cfg・FAT読み取り・PPC ELF handoff
...
[ws027-p001](https://github.com/awemorris/zedBSD/issues/375)
...
[ws003-p034](https://github.com/awemorris/zedBSD/issues/368)から計画を移管。未実行のままであり、旧IDの再利用・試験結果の新規追加ではない。
