<!-- awesome-plan project=zedbsd record=ws027-p003 -->

# ws027-p003: PPC HAL・mac99基板対応とカーネル初期起動
...
[ws027-p002](https://github.com/awemorris/zedBSD/issues/376)
...
[ws003-p035](https://github.com/awemorris/zedBSD/issues/369)から計画を移管。未実行のままであり、旧IDの再利用・試験結果の新規追加ではない。
