<!-- awesome-plan project=zedbsd record=ws027-p004 -->

# ws027-p004: amd64でUSB OHCI・USBストレージを検証
...
[ws003-p036](https://github.com/awemorris/zedBSD/issues/370)から計画を移管。未実行のままであり、旧IDの再利用・試験結果の新規追加ではない。
