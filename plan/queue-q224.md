...
| --- | --- | --- | --- |
| 1 | [ws025-p029](ws025-io-memory-cache/phase029-uas/phase.md) | uncleared | Add optional no-I/O filesystem revoked-unmount preflight and UFS implementation, preserve snapshot refusal and ordinary clean write; focused check and three builds |
