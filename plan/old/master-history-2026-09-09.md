# Master archive — 2026-09-09 整理前

このファイルは整理前のmasterをそのまま保存した履歴です。旧優先順位・保留・進捗は現在の指示ではありません。
現在の状態は [master.md](../master.md) を参照してください。相対リンクを維持するため同じディレクトリに保存しています。
...
Current queue: [q124](../queue.md), finished / p032–p035 completed; [q123](../history/queue-q123.md) finished with p031 uncleared; [q122](../history/queue-q122.md) finished. WS025 mandatory p001–p026 and required WS024 are complete, with integration acceptance, final policy and performance evidence. Conditional p027–p030 are explicitly not adopted and retain planned resume criteria.
Additional planning: [ws025-p031](../ws025/phase031/phase.md) records the agreed driver layout, naming/style consolidation and userland separation. q123 finished with p031 uncleared; regressions p032/p033 take priority before remaining p031 review and any p027–p030 implementation. q122 remains finished.
[q089](../history/queue-q089.md) completed typed BIOS/UEFI memory handoff; [q090](../history/queue-q090.md)
completed sparse RAM mapping and early table ownership, including 16 GiB boots.
[q088](../history/queue-q088.md) completed p001: counters, FS50/Wi-Fi30, three x86 builds and
404 native samples. [Baseline results](../ws025/phase001/results.md).
The user authorized successive finite Queues through WS025 completion on
2026-09-07. Previous [q087](../history/queue-q087.md) finished 2026-09-06: request-sized regular
file syscall I/O ([WS018 p020 results](../ws018/phase020/results.md)). [Q086](../history/queue-q086.md) completed all four phases
and [50 acceptance stories](../ws018/phase019/results.md).
...
independent [WS025](../ws025/ws.md), including removal of the
...
Priority update (2026-09-09): [ws025-p032](../ws025/phase032/results.md) completed: i386 stack overflow repaired; PC98 overlay/native persistent sessions, loader 16/16, PCAT/amd64 builds and login smoke pass. AX211 automatic connection/DHCP regression p033 is in progress under q124.
...
The archived [q039](../history/queue-q039.md) first proves the
...
environment rather than receiving a speculative repair. The archived [q040](../history/queue-q040.md)
...
[q044](../history/queue-q044.md) records the completed input ownership and bounded HID
parser milestones. The archived [q045](../history/queue-q045.md) records the independent
WS004 SuperSpeed interrupt-context automatic/source correction. The completed
[q046](../history/queue-q046.md) reconciles the producer-linked evdev/input and kernel
boot-parameter references. The archived [q047](../history/queue-q047.md) completed the
...
archived [q048](../history/queue-q048.md) completes the WS006 p008 automatic HID milestone
with xHCI and paired EHCI/UHCI acceptance; it does not claim the remaining
physical IN-T42 observation. Completed [q049](../history/queue-q049.md) contains WS004
...
Completed [q050](../history/queue-q050.md) closes the two VFS prerequisites under their
...
The completed [q051](../history/queue-q051.md) closes `ws005-p005`: the real root/non-root
`/sbin/net wifi set-key`, read-side inode replacement rejection, and
abrupt-stop/reboot persistence boundaries pass. Completed [q052](../history/queue-q052.md)
...
[q053](../history/queue-q053.md) then completed the documentation-only `ws005-p002`
...
attributed to that design Phase. The archived [q054](../history/queue-q054.md) completed
...
WS004 p030's automatic RTL8822BU lifecycle milestone. Q070 then closed
...
Completed [q075](../history/queue-q075.md) localized excessive FAT backing-chain traversal
...
driven cross-driver review follows that physical checkpoint. Q063
...
archived [q038](../history/queue-q038.md) replaced the
...
The archived [q037](../history/queue-q037.md) passed every automatic native PC-98 IPL and
...
The archived [q036](../history/queue-q036.md) completed the generic Variant and three
...
The archived [q035](../history/queue-q035.md) completed the retained WS018 graphics
...
complete. The archived [q034](../history/queue-q034.md) completed
...
[q033](../history/queue-q033.md) completed `ws003-p020`: its implementation,
host/negative fixtures, BIOS USB gate, OVMF 4/8/16-GiB matrix, and one CF-SV7
observation pass.
The archived
[q032](../history/queue-q032.md) made i386 PC/AT and amd64 BIOS `BOOTZBSD.EXE` consume
...
completed [q030](../history/queue-q030.md) implemented `ws004-p022` through
...
The archived [q028](../history/queue-q028.md) corrected the IAD-less, Union-associated CDC
...
carrier or packet transfer. The archived [q027](../history/queue-q027.md) completed all six
...
remain in WS005. The archived [q026](../history/queue-q026.md) completed the
...
[q025](../history/queue-q025.md) disabled the
...
archived [q024](../history/queue-q024.md) passed automated Noct gates but is recorded
...
archived [q023](../history/queue-q023.md) completed `ws003-p016`, `ws008-p005`, and
`ws001-p014` in that order without reaching a human-decision boundary. The archived
[q022](../history/queue-q022.md) published the Noct maintainer-review correction as upstream commit
...
[q021](../history/queue-q021.md) completed all four WS016 runtime-swap Phases, including
six passing amd64 UEFI runtime and representative boot-regression cells. The
archived [q020](../history/queue-q020.md) completed `ws006-p005`, `ws008-p002`, and
...
lifecycle evidence. The preceding [q019](../history/queue-q019.md) completed
`ws008-p001`, honestly stopped p002 before implementation, and did not start
dependency-gated p003. The
preceding [q018](../history/queue-q018.md) completed `ws012-p003` through p006 and closed
WS012 after ZSV1, argv/persistent policy, the interactive console, and
production integration all passed. [q017](../history/queue-q017.md) completed
`ws012-p002`: the strict YAML rc.conf host
fixtures, production build, and disposable amd64 QEMU persistence/reboot proof
all passed. [q016](../history/queue-q016.md) completed `ws004-p009`.
[q015](../history/queue-q015.md) completed `ws003-p011`--`p015`: BR-T46 passed all 31
...
and also reached X/`zterm`. Earlier records include [q013](../history/queue-q013.md),
[q012](../history/queue-q012.md), and
[q011](../history/queue-q011.md). Other closed archived records are
retained as [q001](../history/queue-q001.md), [q002](../history/queue-q002.md),
[q003](../history/queue-q003.md), [q004](../history/queue-q004.md),
[q005](../history/queue-q005.md), [q006](../history/queue-q006.md),
[q007](../history/queue-q007.md), [q008](../history/queue-q008.md), and
[q009](../history/queue-q009.md), and [q010](../history/queue-q010.md).
...
| --- | --- | --- | --- | --- | --- |
| `ws001` | POSIX.1-2024 compliance | Active ledger; q050 completed both VFS prerequisites discovered by q041 | `ws001-p022` and `ws001-p023` complete with production-linked faults and abrupt-stop/remount evidence | Retain p022/p023 as regressions and select the next unresolved p020 audit item; WS005 consumed the released VFS dependencies | [WS001](../ws001/ws.md) |
| `ws002` | System services | Complete baseline; p022 corrective complete | `ws002-p022` complete; USB submit-commit local-IRQ self-wait repaired and five final exact-login boots pass | Retain the p022 regression; p021 remains separately planned and non-blocking | [WS002](../ws002/ws.md) |
...
| `ws004` | Hardware expansion | P046 complete q083; p047/p048 complete (`q085`) | Independent checked stop and observable completion; focused common/AX211/RTL lifecycle gates and three builds pass | Q085 RF/QEMU untested; prior hardware evidence remains historical; other hardware follow-ups retained | [WS004](../ws004/ws.md) |
| `ws005` | Networking and WLAN | Historical q071 acceptance; p012 complete (`q085`) | Managed rewrite/P048 integration; all 30 ordinary and sanitized command stories, regressions and builds pass | Individual host acceptance evidence in P012; nonblocking list preserved; physical RF not rerun | [WS005](../ws005/ws.md) |
| `ws006` | Input and evdev | Active; p008 complete after q048 automatic evidence and the user's physical USB HID confirmation | Report-Protocol HID works on hardware; `/dev/mouse` is absent and Xzed already uses evdev-only input | Queue p009 to remove event/key-state `/dev/console` UAPI while preserving ordinary character/TTY input | [WS006](../ws006/ws.md) |
| `ws007` | Graphics and desktop | Active; q039 PC-98 cascade repair complete, q043 local exact-reproduction matrix passes while the newer GUI report remains external | `ws007-p001` and `p003` complete; p004 uncleared; amd64 `p002` carried | Resume p004 only from the user's exact failing image/QEMU/interactive-backend/focus record; do not alter the passing headless path speculatively | [WS007](../ws007/ws.md) |
| `ws008` | Noct and BeUI | Complete (`q063`) | p010 host CLI/toolchain/ordinary-build and p009 amd64 static/package/q35-xHCI runtime gates pass on official `v2.0.1`; p006 remains historical review evidence | No current Phase; Remacs and i386/PC-98 target Noct remain explicitly outside q063 | [WS008](../ws008/ws.md) |
| `ws009` | Documentation | Active; completed-producer follow-up complete (`q072`) | `ws009-p006` completes current WLAN, physical USB HID, Intel Mac Variant, Noct 2.0.1, and project LLVM references | Return producer-specific documentation to its owning implementation Phase; remaining DOC ledger items stay scoped | [WS009](../ws009/ws.md) |
| `ws010` | Noct scripting and x86 image tools | Complete (`q063`) | `ws010-p001`–`p005` complete; all 177 maintained userland Makefiles expose the common lifecycle and top-level download materializes declared external inputs | No current Phase; extract a new requirement before resuming | [WS010](../ws010/ws.md) |
| `ws011` | Network configuration console | Automatic milestone complete (`q075`); physical acceptance and held VLAN/bridge remain | p007/p009 complete: FAT traversal correction, deterministic cost/fault gates and four post-fix T021 cells pass; p004 blocked by MB-010 | Retain regressions; queue p008 only after explicit physical transport/topology/recovery selection | [WS011](../ws011/ws.md) |
| `ws012` | Service administration console | Complete (`q018`) | `ws012-p006` complete | No current Phase; extract a new requirement or continue container integration in WS013 | [WS012](../ws012/ws.md) |
| `ws013` | CPAR container partitioning | Active; q031/q032 configured x86 boot paths complete, Runtime topics manually blocked | `ws013-p002`--`p006` complete | No Boot configuration Phase remains; resume Runtime namespace/CLI/package design only after its explicit manual holds are released | [WS013](../ws013/ws.md) |
| `ws014` | Native GPU stack | Blocked by manual hold | `ws014-p001` is blocked before detailed design | Resume only after explicit user release | [WS014](../ws014/ws.md) |
| `ws015` | μITRON asymmetric real-time domain | Blocked by manual hold `MB-007`; user-mode RT direction recorded | `ws015-p001` is the only current Phase | After explicit hold release, select the μITRON profile and freeze the remaining RT/POSIX, mailbox/filesystem, failure, and timing contracts | [WS015](../ws015/ws.md) |
| `ws016` | Runtime swap control | Complete (`q021`) | `ws016-p004` complete; SWAP-T001--T012 and the six-cell amd64 UEFI matrix pass | No Phase remains; extract a new requirement before resuming | [WS016](../ws016/ws.md) |
| `ws017` | `/dev/graphics` LFB fast path | Queue-ready; permission ceiling selected | No Phase started; p001 Queue-ready | After WS022, Queue p001--p004; RW mappings may return from RO to RW within their original maximum | [WS017](../ws017/ws.md) |
| `ws018` | Kernel source ownership and interface consolidation | p001--p020 complete (`q087`) | q086 FS/USB 50-story gate; q087 request-sized syscall transfers, three x86 builds and native USB-root persistence pass | No selected phase remains; I/O/cache/write-back follow-up is planned under WS025, with unrelated residuals retained in the FS follow-up matrix | [WS018](../ws018/ws.md) |
| `ws019` | Installation and disk administration | Active; q079 formatters complete | p002/p003, p008/p009 and p010/p011/p012 complete | Resolve p004 provenance/publication prerequisites before p004/p005 installer work | [WS019](../ws019/ws.md) |
| `ws020` | Intel Mac UEFI bring-up and generic image variants | Complete (user physical confirmation, 2026-09-05) | Automatic Variant/GPT/QEMU gates and successful Intel Mac real-hardware operation pass | No Phase remains; explicit acceptance supersedes the older five-run campaign | [WS020](../ws020/ws.md) |
| `ws021` | Reproducible x86 LLVM toolchain and sysroots | Complete (`q064`) | LLVM 23.1.0 cache/source paths, amd64/i386 sysroots, all x86 target/loader builds, four CI configurations, six-cell amd64 firmware matrix, i386 PC/AT and PC-98, and target noct non-JIT/JIT/BeUI gates pass | No current Phase; the source-build path and pinned `rev-0` cache remain supported in parallel | [WS021](../ws021/ws.md) |
| `ws022` | ELF `PT_TLS` and static thread-local storage | Queue-ready; WS021 dependency satisfied | No Phase started | Queue p001 to freeze the x86 TLS/TCB ABI and fixtures, then implement p002/p003 | [WS022](../ws022/ws.md) |
| `ws023` | i386/amd64 HAL coding-style conformance | Complete (`q067`) | All 88 C/header files, focused/strict gates, four configured builds, and four x86 runtime cells pass; API/ABI review found no delta | No current Phase; retain the q067 evidence and extract pre-existing risks separately if prioritized | [WS023](../ws023/ws.md) |
| `ws024` | Single 64-bit UFS | Complete (q102) | p001–p004 complete; U01–U24 selected acceptance, storage 50/50, WiFi 30, three builds and source retirement pass | WS025 batching consumes the single unified owner | [WS024](../ws024/ws.md) |
...
[Finished q076](../history/queue-q076.md) completed `ws019-p002` basic queries and p003
...
idle GPT/MBR round-trips passed. Four bounded launches are recorded, including
the additional p012 window; the last stopped at the fixture's unsupported
nested mount path. [Evidence and corrected resume](../ws019/tests/q076-results.md)
require a new Queue, not an automatic retry. Any mounted child, including
...
[WS018 p013](../ws018/phase013/phase.md)
was approved and executed in [q077](../history/queue-q077.md). Its mandatory mounted-directory
test reproduced a baseline bug, before and after cleanup. The user's explicit
follow-up selects [p014](../ws018/phase014/phase.md)
...
[p015](../ws018/phase015/phase.md), retaining
...
[Q077 evidence and limits](../ws018/tests/q077-results.md)
...
1. WS019 p008 target UFS1-in-file `/sbin/mkfs` and p009 target
   ...
   [Final acceptance](../ws019/tests/q079-results.md) includes target
...
outside this wave until separately prioritized or unblocked.
...
On 2026-09-06 the user requested recording [WS024](../ws024/ws.md):
...
feasibility on `awe@10.0.10.25`. [WS004 p045](../ws004/phase045/phase.md)
...
exact `2357:0138` has both measured HS and SS profiles. [P046](../ws004/phase046/phase.md)
...
[WS025](../ws025/ws.md) records the requested independent design
...
| VLAN/bridge virtual-interface UAPI and packet ownership | WS005/WS011 | Manually blocked again as `MB-010` on 2026-09-05; resume p004 only after explicit release |
...
| `MB-010` | `ws011-p004` | VLAN/bridge virtual-interface UAPI, packet ownership, filtering, persistence, and implementation | User explicitly resumes VLAN/bridge design |
...
[governance.md](pre-awesome-governance.md).
...
2026-09-09 追加: q124 に [ws025-p034](../ws025/phase034/phase.md) を追加（pending、最新依頼で実行承認済み）。AX211 の直接 up/down/connect 反復後の無限エラーを再現・修正する。p033 実機試験後に実行。

q124 進捗: p033 DHCP 復旧中に AX211 の反復 rollback エラーを実機再現したため、p034 を in-progress として原因修正を先行する。p033 は受け入れ未完了のまま保持する。

追加依頼: q124 に [ws025-p035](../ws025/phase035/phase.md) を追加（pending、実行承認済み）。AX211＋RTL8822BU の同時自動接続と遅延を確認・修正する。p034 反復試験後に開始。

q124 最新: p032–p034 completed。AX211 反復24操作、association cancel、DHCP loss/recovery とホスト復元完了。p035 複数無線 baseline 実行中。

q124 最終: p032–p035 completed / Queue finished。複数Wi-Fi待機短縮、両radio実通信、取消し復旧、単独AX211反復、3 architecture buildまで完了。[p035実行結果](../ws025/phase035/results.md)に測定条件と残存firmware assertを記録した。
