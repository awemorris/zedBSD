...
Date: 2026-09-06. Status: 50/50 PASS in q086; see [results](../ws018/phase019/results.md).
These are the historical q086 definitions. Q087 supersedes S37's 4096-byte
splitting with request-sized transfers; see [new acceptance and evidence](../ws018/phase020/results.md).
