...
- W book: `plan/wsXXX/ws.md` — one workstream's outcome, scope,
  dependencies, phases, and completion conditions.
- P book: `plan/wsXXX/phaseYYY/phase.md` — one bounded phase's
...
Existing identifiers are immutable. By user instruction on 2026-09-10, WS and
Phase directories use numeric names only (`ws025/phase029/`); do not add slugs.
This repository
...
Reusable phase/WS fixtures belong under `plan/wsXXX/tests/`. Disposable
...
in [ws025-p036](../ws025/phase036/phase.md). Keep any
...
[HAL interface proposal](../ws025/hal-interface-proposal.md), including
