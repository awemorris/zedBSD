...
[受け入れ結果](../ws018/phase019/results.md)を参照。
...
[その結果](/home/awe/zedBSD/plan/ws005/phase012/results.md)は有効なまま、
...
既にユーザーが決定した[WS024の単一64bit UFS方針](/home/awe/zedBSD/plan/ws024/ws.md)は維持する。
...
例: `plan/ws018/tests/run-fat-native-vfs-host-test.sh`、
`plan/ws004/tests/run-usb-recovery-contract-test.sh`、
`plan/ws019/tests/run-storage-foundation-test.sh`。
