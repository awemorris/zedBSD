...
| --- | --- | --- | --- |
| 1 | [ws018-p020](ws018-kernel-architecture/phase020-syscall-request-batching/phase.md) | completed | Replace fixed 4KiB regular-file splitting with request-sized bounded allocation; q086 complete |

Prior results: [q086](queue-q086.md). No commit or aggregate make check.
Result: [q087 evidence](ws018-kernel-architecture/phase020-syscall-request-batching/results.md).
