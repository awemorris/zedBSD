...
| --- | --- | --- | --- |
| 1 | [ws025-p022](ws025-io-memory-cache/phase022-exec-cache-snapshot/phase.md) | uncleared | Implement and verify immutable-input content leases and canonical cache reads as the first owner for exec snapshots. Dependencies p015/p016 and existing p006 loader are complete. |
