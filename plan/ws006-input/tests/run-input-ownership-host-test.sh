...
sources="$repo/plan/ws006-input/tests/input-ownership-test.c $repo/src/drivers/generic/input.c $repo/plan/ws006-input/tests/input-host-unreachable.c"
...
device_sources="$repo/plan/ws006-input/tests/input-device-ownership-test.c $repo/src/drivers/generic/input.c $repo/plan/ws006-input/tests/input-host-unreachable.c"
...
console_sources="$repo/plan/ws006-input/tests/console-input-ownership-test.c $repo/src/drivers/generic/console.c $repo/src/drivers/generic/input.c $repo/plan/ws006-input/tests/input-host-unreachable.c"
...
cc $common "$repo/plan/ws006-input/tests/x68k-keyboard-ownership-test.c" \
	...
	"$repo/src/drivers/generic/input.c" "$repo/plan/ws006-input/tests/input-host-unreachable.c" \
	-o "$temporary/x68k"
"$temporary/x68k"
cc $common -g -fno-omit-frame-pointer -fsanitize=address,undefined \
...
pc98_sources="$repo/plan/ws006-input/tests/pc98-keyboard-ownership-test.c $repo/src/hal/i386/bsp-pc98/cons.c $repo/src/drivers/generic/input.c $repo/plan/ws006-input/tests/input-host-unreachable.c"
