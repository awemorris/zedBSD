...
sources="$repo/plan/ws006-input/tests/input-ownership-test.c $repo/plan/ws025-io-memory-cache/temp/p031-driver-fragments/src/drivers/input-subscriber.c $repo/plan/ws025-io-memory-cache/temp/p031-driver-fragments/src/drivers/input-keymap.c $repo/plan/ws025-io-memory-cache/temp/p031-driver-fragments/src/drivers/input-capability.c $repo/plan/ws025-io-memory-cache/temp/p031-driver-fragments/src/drivers/input-queue.c"
...
device_sources="$repo/plan/ws006-input/tests/input-device-ownership-test.c $repo/plan/ws025-io-memory-cache/temp/p031-driver-fragments/src/drivers/input-device.c $repo/plan/ws025-io-memory-cache/temp/p031-driver-fragments/src/drivers/input-subscriber.c $repo/plan/ws025-io-memory-cache/temp/p031-driver-fragments/src/drivers/input-keymap.c $repo/plan/ws025-io-memory-cache/temp/p031-driver-fragments/src/drivers/input-capability.c $repo/plan/ws025-io-memory-cache/temp/p031-driver-fragments/src/drivers/input-queue.c"
...
console_sources="$repo/plan/ws006-input/tests/console-input-ownership-test.c $repo/src/drivers/generic/console.c $repo/plan/ws025-io-memory-cache/temp/p031-driver-fragments/src/drivers/input-keymap.c"
...
cc $common "$repo/plan/ws006-input/tests/x68k-keyboard-ownership-test.c" \
	...
	"$repo/plan/ws025-io-memory-cache/temp/p031-driver-fragments/src/drivers/input-keymap.c" \
	-o "$temporary/x68k"
"$temporary/x68k"
cc $common -g -fno-omit-frame-pointer -fsanitize=address,undefined \
...
pc98_sources="$repo/plan/ws006-input/tests/pc98-keyboard-ownership-test.c $repo/src/hal/i386/bsp-pc98/cons.c $repo/plan/ws025-io-memory-cache/temp/p031-driver-fragments/src/drivers/input-keymap.c"
