...
| --- | --- | --- | --- |
| 1 | [ws022-p001](ws022-elf-tls/phase001-contract-and-fixtures/phase.md) | completed | 現TCB・x86 HAL・rtldを調査し、static TLS layout、所有権、compiler ELFと不正ELF fixtureを確定。 |
...
結果: [契約とfixture証拠](ws022-elf-tls/phase001-contract-and-fixtures/contract.md)。p002/p003実行前のABI判断は確定。
