...
| --- | --- | --- | --- |
| 1 | [ws019-p037](ws019-installation/phase037-native-ufs-command/phase.md) | completed | Shared device frontend, 4-GiB native format/mount/attribute copy, FAT regression and three builds pass |
...
Accepted: [p037 results](ws019-installation/phase037-native-ufs-command/results.md).
