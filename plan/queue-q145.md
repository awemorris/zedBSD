...
| --- | --- | --- | --- |
| 1 | [ws025-p029](ws025-io-memory-cache/phase029-uas/phase.md) | uncleared | Production parser implemented; ordinary and sanitized 10,209 checks each and three-platform builds pass; transport remains |
