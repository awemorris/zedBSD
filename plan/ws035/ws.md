...
| [ws035-p064](phase064/phase.md) | （同）物理的に追従するドッキングの解除（引くと縮み、閾値で snap、届かなければバネで戻る） | cleared（q482-i01、2026-09-26。Venus で引くと縮み、手前で戻り、越えると外れる） | p062 | 同上 |
