...
| [ws035-p070](phase070/phase.md) | （2026-09-26 自律実行）App Home から X11 の app（zterm、zgears）: Xzed --rootless を必要なときに起動 | in-progress（q479-i01） | p069、WS069 | `userland/base/zwl` |
