...
run("syscall-cells", ["python3","plan/ws018-kernel-architecture/tests/run-storage-syscall-stories.py"])
run("claim", ["sh","plan/ws016-swap-control/tests/run-backing-claim-test.sh"])
