...
| --- | --- | --- | --- |
| 1 | [ws025-p029](ws025-io-memory-cache/phase029-uas/phase.md) | uncleared | Checked host retirement followed by distinct-tag ABORT TASK, bounded response validation, next-request recovery without replay, sticky failed-write/flush status; focused fault tests and builds |
