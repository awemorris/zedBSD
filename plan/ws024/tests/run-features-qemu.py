...
spec = importlib.util.spec_from_file_location('format_runner', repo / 'plan/ws019/tests/run-formatter-qemu.py')
...
out.relative_to(repo / 'plan/ws024/temp')
...
if legacy:
    ...
    spec = importlib.util.spec_from_file_location('orphan_image',
        repo / 'plan/ws025/tests/orphan-image.py')
