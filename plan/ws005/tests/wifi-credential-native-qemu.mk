...
WS005_P005_SOURCE := \
	plan/ws005/tests/wifi-credential-native.c
WS005_P005_OBJECT := \
	$(BUILD)/user64/plan/ws005/tests/wifi-credential-native.o
...
WS005_P005_CONFIG := \
	plan/ws005/tests/wifi-credential-native.cfg
WS005_P005_PASSWD := \
	plan/ws005/tests/wifi-credential-native-passwd
WS005_P005_GROUP := \
	plan/ws005/tests/wifi-credential-native-group
