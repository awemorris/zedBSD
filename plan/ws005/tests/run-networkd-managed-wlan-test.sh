...
cc -std=c11 -DKERN_USER_ABI_LP64 -Wall -Wextra -Werror \
	...
	"$repo/plan/ws005/tests/networkd-managed-wlan-test.c" \
...
cc -std=c11 -DKERN_USER_ABI_LP64 -Wall -Wextra -Werror -fanalyzer \
	-I"$repo/include/uapi" -I"$repo/libc/include" -I"$repo" \
...
cc -std=c11 -DKERN_USER_ABI_LP64 -Wall -Wextra -Werror \
	...
	-I"$repo/include/uapi" -I"$repo/libc/include" -I"$repo" \
	"$repo/plan/ws005/tests/networkd-radio-preparation-test.c" \
...
cc -std=c11 -DKERN_USER_ABI_LP64 -Wall -Wextra -Werror \
	-ffunction-sections -fdata-sections \
	-I"$repo/include/uapi" -I"$repo/libc/include" -I"$repo" \
	"$repo/plan/ws005/tests/networkd-wifi-selection-test.c" \
	"$repo/userland/base/networkd/managed-wlan.c" \
