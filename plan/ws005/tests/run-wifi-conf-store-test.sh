...
base=${TMPDIR:-$repo/plan/ws005/temp}
mkdir -p "$base"
...
sources='userland/base/net/wifi-conf.c userland/base/net/wifi-store.c plan/ws005/tests/wifi-store-test.c'
...
cc -std=c11 -D_DEFAULT_SOURCE -I. -Wall -Wextra -Werror \
  ...
  plan/ws005/tests/wifi-conf-model-test.c \
