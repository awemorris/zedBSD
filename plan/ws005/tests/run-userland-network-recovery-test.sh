...
$cc $common "$root/plan/ws005/tests/dhcpc-state-test.c" \
	"$root/userland/base/net/dhcp.c" \
	$discard -o "$work/dhcpc-state-test"
"$work/dhcpc-state-test"

# shellcheck disable=SC2086
$cc $common "$root/plan/ws005/tests/networkd-status-test.c" \
...
# shellcheck disable=SC2086
$cc $common "$root/plan/ws005/tests/strerror-network-test.c" \
...
$cc $common -fanalyzer -c \
	"$root/plan/ws005/tests/dhcpc-state-test.c" \
...
# shellcheck disable=SC2086
$cc $common -fsanitize=address,undefined -fno-omit-frame-pointer \
	"$root/plan/ws005/tests/networkd-status-test.c" $discard \
