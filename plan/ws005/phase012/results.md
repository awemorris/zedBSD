...
```sh
sh plan/ws005/tests/run-wifi-stories.sh
STORY_VARIANT=sanitize sh plan/ws005/tests/run-wifi-stories.sh
```
...
`plan/ws005/temp/q085-wifi-scenarios/stories-final-ordinary.log` and
...
fixtures documented in [P048 results](../../ws004/phase048/results.md).

## Maintained regressions and source corrections

All these runners under `plan/ws005/tests/` passed their ordinary,
