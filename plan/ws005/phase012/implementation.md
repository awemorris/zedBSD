...
`plan/ws005/temp/q085-wifi-scenarios/review2-*-build.log`.
...
`plan/old/net-wifi-report.md` is preserved unchanged.
...
[WS004 p047](../../ws004/phase047/phase.md),
with [per-finding dispositions](../../ws004/phase047/review-response.md).
