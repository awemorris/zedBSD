...
Architecture: [WLAN v1 control contract](../phase002/phase.md)

Authentication: [AF_UNIX peer credentials](../phase003/phase.md)

Primitive: [wifi ioctl command](../phase004/phase.md)

Profiles: [Wi-Fi credential store](../phase005/phase.md)
...
- [`ws005-p004`](../phase004/phase.md) supplies the minimum
...
- [`ws005-p005`](../phase005/phase.md) versioned
...
- [`ws005-p009`](../phase009/phase.md) first proves
...
- [`ws005-p010`](../phase010/phase.md) completes the
