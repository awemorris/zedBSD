...
carried in [WS001](../ws.md); all three matrix rows remain
...
6. update the Phase 10 progress and affected component rows in
   [WS001](../ws.md). Do not leave notes that describe the
   removed port.
...
6. update the `P10-*` replacement gates plus every affected subsystem/API/libc
   row in [WS001](../ws.md) during the same work unit.
...
- [WS001](../ws.md) records the completed replacement gates and
