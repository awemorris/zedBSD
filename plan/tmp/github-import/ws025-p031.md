<!-- awesome-plan project=zedbsd record=ws025-p031 -->

既存計画の取り込み。本文はローカルの現行記録、リポジトリ資料へのリンクは基準コミットの履歴です。Issue作成・open状態は実行承認や未完了判定を意味しません。Awesome Planの状態同期導入前のため、実際の状態は本文を参照してください。

元資料: `plan/ws025/phase031/phase.md`
...
ドライバ定義を `drv_` に統一する。[coding-style.md](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/coding-style.md) を
...
[全ソースの移行表](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws025-io-memory-cache/phase031-driver-layout-style/source-map.tsv) に、計画時点の139ファイルの移動・統合先を
...
[coding-style.md](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/coding-style.md) 全体を正とし、特に以下をレビューする。
