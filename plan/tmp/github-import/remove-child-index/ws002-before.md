...
- [ws002-p011](https://github.com/awemorris/zedBSD/issues/53)
- [ws002-p012](https://github.com/awemorris/zedBSD/issues/54)
- [ws002-p013](https://github.com/awemorris/zedBSD/issues/55)
- [ws002-p014](https://github.com/awemorris/zedBSD/issues/56)
- [ws002-p015](https://github.com/awemorris/zedBSD/issues/57)
- [ws002-p016](https://github.com/awemorris/zedBSD/issues/58)
- [ws002-p017](https://github.com/awemorris/zedBSD/issues/59)
- [ws002-p018](https://github.com/awemorris/zedBSD/issues/60)
- [ws002-p019](https://github.com/awemorris/zedBSD/issues/61)
- [ws002-p020](https://github.com/awemorris/zedBSD/issues/62)
- [ws002-p021](https://github.com/awemorris/zedBSD/issues/63)
- [ws002-p022](https://github.com/awemorris/zedBSD/issues/64)
- [ws002-p023](https://github.com/awemorris/zedBSD/issues/65)
- [ws002-p024](https://github.com/awemorris/zedBSD/issues/66)


既存計画の取り込み。本文はローカルの現行記録、リポジトリ資料へのリンクは基準コミットの履歴です。Issue作成・open状態は実行承認や未完了判定を意味しません。Awesome Planの状態同期導入前のため、実際の状態は本文を参照してください。

元資料: `plan/ws002/ws.md`
...
See [completion reconciliation](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/completion.md) and
[p021 closure](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/phase021-missing-login-session-teardown/closure.md).
...
Shared tests: [WS002 test index](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/tests/README.md)
...
[WS001](https://github.com/awemorris/zedBSD/issues/2), and the Phase acceptance result states
...
| --- | --- | --- | --- |
| `ws002-p011` | [service foundation](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/phase011-service-foundation/phase.md) | Complete | Parsers, formats, path policy, tests, and `/sbin` classification are stable |
| `ws002-p012` | [init and service lifecycle](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/phase012-init/phase.md) | Complete | Native PID 1 boots, controls services, mounts filesystems, and shuts down orderly |
| `ws002-p013` | [system logging](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/phase013-logging/phase.md) | Complete | `logger`, `/run/log`, `syslogd`, boot log persistence, and messages work |
| `ws002-p014` | [console sessions](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/phase014-sessions/phase.md) | Complete | Supervised `getty` reaches `login` and respawns safely |
| `ws002-p015` | [network management](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/phase015-network/phase.md) | Complete baseline | `networkd` and `net` configure static IPv4 and initial DHCP |
| `ws002-p016` | [scheduled work](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/phase016-scheduling/phase.md) | Complete baseline | `cron`, `crontab`, `at`, and `batch` execute jobs with durable state |
| `ws002-p017` | [initial time](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/phase017-time/phase.md) | Complete optional feature | Bounded `ntpdate` works without making boot depend on network time |
| `ws002-p018` | [POSIX shell](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/phase018-shell/phase.md) | Partial with handoffs | Shell is usable; remaining incompatibilities are recorded in WS001 |
| `ws002-p019` | [integrated QEMU acceptance](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/phase019-integration/phase.md) | Complete minimum system | Boot, login, services, jobs, network, and shutdown were exercised and repaired |
| `ws002-p020` | [synchronous network service](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/phase020-network-service/phase.md) | Complete milestone | fd 3 readiness and synchronous `net` orchestration pass host/build/QEMU gates |
| `ws002-p021` | [missing-login session teardown](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/phase021-missing-login-session-teardown/phase.md) | Complete by user acceptance | Current runtime passes; likely corrected historical failure retained as BUG-012 |
| `ws002-p022` | [intermittent console-login progress](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/phase022-intermittent-console-login/phase.md) | Complete | USB submit-commit IRQ self-wait repaired; deterministic old-order regression, unchanged `MAC-T022`, and ordinary initial plus final five exact-login boots pass |
| `ws002-p023` | [USB boot halt](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/phase023-usb-boot-halt/phase.md) | Complete q135 | QEMU reproduction and correction, subsequent paired regression; physical boundary retained |
| `ws002-p024` | [retirement heap integrity](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/phase024-retirement-heap-integrity/phase.md) | Complete q142 | UHCI stale-link correction and heap/lifecycle acceptance |

The original Phase 11–19 detail is retained in the
[legacy aggregate plan](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/history/phase011-019-legacy-plan.md).
...
7. update [WS001](https://github.com/awemorris/zedBSD/issues/2) with actual evidence and remaining
   gaps; and
...
[ws002-p023](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/phase023-usb-boot-halt/phase.md)を追加。BUG-010のQEMU再現と、再現した場合の修正を現在のゴールに含める。p021と独立して扱い、USB解析は実装可能な作業の後段で実行する。

### q135 USB boot halt correction

[p023](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/phase023-usb-boot-halt/phase.md) completed its QEMU reproduction and
...
checks. [Evidence](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/phase023-usb-boot-halt/results.md). q137 also passes paired
...
p021 remains **uncleared** with [new evidence](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/phase021-missing-login-session-teardown/results.md):
...
boot and hotplug succeed. [p024](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/phase024-retirement-heap-integrity/phase.md)
...
[p024 progress](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws002-services/phase024-retirement-heap-integrity/progress.md). The historic
