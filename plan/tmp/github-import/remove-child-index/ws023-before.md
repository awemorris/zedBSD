...
- [ws023-p001](https://github.com/awemorris/zedBSD/issues/309)
- [ws023-p002](https://github.com/awemorris/zedBSD/issues/310)
- [ws023-p003](https://github.com/awemorris/zedBSD/issues/311)
- [ws023-p004](https://github.com/awemorris/zedBSD/issues/312)
- [ws023-p005](https://github.com/awemorris/zedBSD/issues/313)
- [ws023-p006](https://github.com/awemorris/zedBSD/issues/314)
- [ws023-p007](https://github.com/awemorris/zedBSD/issues/315)
- [ws023-p008](https://github.com/awemorris/zedBSD/issues/316)
- [ws023-p009](https://github.com/awemorris/zedBSD/issues/317)
- [ws023-p010](https://github.com/awemorris/zedBSD/issues/318)
- [ws023-p011](https://github.com/awemorris/zedBSD/issues/319)


既存計画の取り込み。本文はローカルの現行記録、リポジトリ資料へのリンクは基準コミットの履歴です。Issue作成・open状態は実行承認や未完了判定を意味しません。Awesome Planの状態同期導入前のため、実際の状態は本文を参照してください。

元資料: `plan/ws023/ws.md`
...
Apply [the project C coding style](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/coding-style.md) to every maintained C
...
| --- | --- | --- |
| [ws023-p001](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws023-x86-hal-style/phase001-i386-compressed-core/phase.md) | Complete (`q067`) | Preserve the inherited committed edits and restore the compressed i386 APIC/SMP/page/time sources to the canonical form |
| [ws023-p002](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws023-x86-hal-style/phase002-i386-core-interrupts/phase.md) | Complete (`q067`) | Style the remaining i386 low-level, interrupt, and library sources and headers |
| [ws023-p003](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws023-x86-hal-style/phase003-i386-vm-task/phase.md) | Complete (`q067`) | Style i386 address-space and task/context code without changing MMU or context semantics |
| [ws023-p004](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws023-x86-hal-style/phase004-i386-pcat/phase.md) | Complete (`q067`) | Style the i386 PC/AT boot, console, and PIC implementation |
| [ws023-p005](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws023-x86-hal-style/phase005-i386-pc98/phase.md) | Complete (`q067`) | Style the i386 PC-98 boot, console, display, PIC, and table envelopes |
| [ws023-p006](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws023-x86-hal-style/phase006-amd64-leaf-core/phase.md) | Complete (`q067`) | Establish the amd64 file envelope/private helper and style the small leaf/core modules |
| [ws023-p007](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws023-x86-hal-style/phase007-amd64-interrupt-task/phase.md) | Complete (`q067`) | Style amd64 interrupt, page, SMP, library, and task code |
| [ws023-p008](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws023-x86-hal-style/phase008-amd64-platform-time/phase.md) | Complete (`q067`) | Style amd64 firmware handoff, APIC, clock, and timecounter code |
| [ws023-p009](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws023-x86-hal-style/phase009-amd64-vmspace/phase.md) | Complete (`q067`) | Style the large amd64 address-space implementation independently |
| [ws023-p010](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws023-x86-hal-style/phase010-amd64-console/phase.md) | Complete (`q067`) | Style the large amd64 console/input implementation and all compiled variants |
| [ws023-p011](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws023-x86-hal-style/phase011-x86-final-audit/phase.md) | Complete (`q067`) | Prove complete file coverage and run the combined x86 build/runtime regression |
...
[q067 result ledger](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws023-x86-hal-style/tests/q067-results.md) for exact evidence, retained
