...
- [ws012-p001](https://github.com/awemorris/zedBSD/issues/201)
- [ws012-p002](https://github.com/awemorris/zedBSD/issues/202)
- [ws012-p003](https://github.com/awemorris/zedBSD/issues/203)
- [ws012-p004](https://github.com/awemorris/zedBSD/issues/204)
- [ws012-p005](https://github.com/awemorris/zedBSD/issues/205)
- [ws012-p006](https://github.com/awemorris/zedBSD/issues/206)


既存計画の取り込み。本文はローカルの現行記録、リポジトリ資料へのリンクは基準コミットの履歴です。Issue作成・open状態は実行承認や未完了判定を意味しません。Awesome Planの状態同期導入前のため、実際の状態は本文を参照してください。

元資料: `plan/ws012/ws.md`
...
Shared reviews: [WS012 review index](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws012-service-console/tests/README.md)
...
- [WS002](https://github.com/awemorris/zedBSD/issues/3) supplies init, service definitions,
  supervision, `/etc/rc.conf`, and the current argv command.
- [WS013](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws013-containers/ws.md) may later add container-specific status
...
| --- | --- | --- | --- |
| `ws012-p001` | [Service-console design discussion](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws012-service-console/phase001-design-discussion/phase.md) | Complete | YAML, ZSV1, grammar, policy, permissions, and concurrency decisions accepted |
| `ws012-p002` | [YAML rc.conf model and persistence foundation](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws012-service-console/phase002-yaml-rcconf/phase.md) | Complete (`q017`) | Strict model, parser, canonical writer, stable lock, atomic replacement, and all-reader migration |
| `ws012-p003` | [ZSV1 init service-control protocol](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws012-service-console/phase003-zsv1-init-protocol/phase.md) | Complete (`q018`, 2026-08-28) | Replace the old socket grammar with bounded versioned service/system-action records and typed service/shutdown clients |
| `ws012-p004` | [Non-interactive service CLI and persistent policy](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws012-service-console/phase004-service-argv-persistence/phase.md) | Complete (`q018`, 2026-08-28) | Stable argv grammar/output, runtime controls, immediate locked enable/disable, and reload |
| `ws012-p005` | [Interactive service console](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws012-service-console/phase005-interactive-console/phase.md) | Complete (`q018`, 2026-08-28) | Argument-free prompt reuses the argv dispatcher with no candidate/save state |
| `ws012-p006` | [Service-console integration acceptance](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws012-service-console/phase006-integration-acceptance/phase.md) | Complete (`q018`, 2026-08-28) | Host/QEMU lifecycle, concurrency, persistence, failure, cold boot, and documentation evidence |
...
[`ws001-p014`](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws001-posix/phase014-shell-job-control/phase.md), not hidden
inside this completed WS. Exact evidence is indexed by the
[p006 result matrix](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws012-service-console/tests/q018-p006-results.tsv).
