...
- [ws021-p001](https://github.com/awemorris/zedBSD/issues/299)
- [ws021-p002](https://github.com/awemorris/zedBSD/issues/300)
- [ws021-p003](https://github.com/awemorris/zedBSD/issues/301)
- [ws021-p004](https://github.com/awemorris/zedBSD/issues/302)
- [ws021-p005](https://github.com/awemorris/zedBSD/issues/303)
- [ws021-p006](https://github.com/awemorris/zedBSD/issues/304)
- [ws021-p007](https://github.com/awemorris/zedBSD/issues/305)


既存計画の取り込み。本文はローカルの現行記録、リポジトリ資料へのリンクは基準コミットの履歴です。Issue作成・open状態は実行承認や未完了判定を意味しません。Awesome Planの状態同期導入前のため、実際の状態は本文を参照してください。

元資料: `plan/ws021/ws.md`
...
Shared tests: [WS021 test and evidence index](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws021-llvm-toolchain/tests/README.md)
...
| --- | --- | --- |
| [`ws021-p001`](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws021-llvm-toolchain/phase001-llvm-source-and-zedbsd-target/phase.md) | Complete (`q064`) | Verified LLVM 23.1.0 acquisition and strict zedBSD OS/triple/driver/compiler-rt patch boundary |
| [`ws021-p002`](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws021-llvm-toolchain/phase002-host-llvm-build/phase.md) | Complete (`q064`) | `make toolchain` installs the required X86 Clang/LLD/LLVM tools below `build/llvm/` while host Noct remains host-built |
| [`ws021-p007`](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws021-llvm-toolchain/phase007-host-llvm-release/phase.md) | Complete (`q064`) | Publish the validated x86_64 Linux host install as a pinned permanent `rev-0` CI asset |
| [`ws021-p003`](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws021-llvm-toolchain/phase003-x86-sysroots/phase.md) | Complete (`q064`) | Complete amd64 and shared i386 public sysroots with startup, libc, compiler builtins, and linker inputs |
| [`ws021-p004`](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws021-llvm-toolchain/phase004-x86-target-migration/phase.md) | Complete (`q064`) | All x86 kernels and userland, including target Noct, compile/link only through the project LLVM toolchain and sysroots |
| [`ws021-p005`](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws021-llvm-toolchain/phase005-bootloader-toolchain-closure/phase.md) | Complete (`q064`) | BIOS and UEFI loaders plus all x86 disk images build without host target GNU/MinGW tools |
| [`ws021-p006`](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws021-llvm-toolchain/phase006-big-bang-qemu-acceptance/phase.md) | Complete (`q064`) | One final consolidated amd64/i386/PC-98 QEMU campaign accepts the migrated toolchain and target Noct |
