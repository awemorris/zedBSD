...
- [ws020-p001](https://github.com/awemorris/zedBSD/issues/293)
- [ws020-p002](https://github.com/awemorris/zedBSD/issues/294)
- [ws020-p003](https://github.com/awemorris/zedBSD/issues/295)
- [ws020-p004](https://github.com/awemorris/zedBSD/issues/296)
- [ws020-p005](https://github.com/awemorris/zedBSD/issues/297)
- [ws020-p006](https://github.com/awemorris/zedBSD/issues/298)


既存計画の取り込み。本文はローカルの現行記録、リポジトリ資料へのリンクは基準コミットの履歴です。Issue作成・open状態は実行承認や未完了判定を意味しません。Awesome Planの状態同期導入前のため、実際の状態は本文を参照してください。

元資料: `plan/ws020/ws.md`
...
Shared tests: [WS020 test index](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws020-intel-mac/tests/README.md)
...
| --- | --- | --- |
| [`ws020-p001`](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws020-intel-mac/phase001-target-variant-config/phase.md) | Completed (revised 2026-08-31) | Capacity selector removed; generic Variant round-trip and three-way compiled-artifact invariance pass with the requested labels/order |
| [`ws020-p002`](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws020-intel-mac/phase002-image-layouts/phase.md) | Completed (revised 2026-08-31) | Fixed pure-PMBR primary-only UEFI layout and larger-medium kernel handling pass strict image and GPT host gates |
| [`ws020-p003`](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws020-intel-mac/phase003-qemu-acceptance/phase.md) | Complete (`q047`, 2026-08-31) | One fresh uninterrupted `MAC-T020` run passed all six strict positive/negative cells; every positive reached exact `login:` and every immutable source remained unchanged |
| [`ws020-p004`](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws020-intel-mac/phase004-physical-bringup/phase.md) | Complete (user physical confirmation, 2026-09-05) | Intel Mac real-hardware operation passes; explicit acceptance supersedes the older five-cold-boot campaign |
| [`ws020-p005`](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws020-intel-mac/phase005-production-uefi-preflight/phase.md) | Completed (`q038`); refreshed `q047` | Current two-partition UEFI-only source passed `MAC-T021` and partition publication ordinary/sanitizer/analyzer gates; exact checked hash `f811a0f5...` is installed |
| [`ws020-p006`](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws020-intel-mac/phase006-relocated-physical-gpt/phase.md) | Complete (automatic plus user physical confirmation) | GPT precedence, host/sanitizer/analyzer, relocated/pristine QEMU, exact login, six-cell gates, and Intel Mac hardware operation pass |
