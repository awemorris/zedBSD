<!-- awesome-plan project=zedbsd record=ws003-p004 -->

既存計画の取り込み。本文はローカルの現行記録、リポジトリ資料へのリンクは基準コミットの履歴です。Issue作成・open状態は実行承認や未完了判定を意味しません。Awesome Planの状態同期導入前のため、実際の状態は本文を参照してください。

元資料: `plan/ws003/phase004/phase.md`
...
Tests: [WS003 test index](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws003-bringup/tests/README.md)

Evidence: [Latitude xHCI evidence](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws003-bringup/tests/latitude-xhci-evidence.md)
...
- `plan/ws003/tests/` fixtures, runbook, and evidence
...
[ws003-p010](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws003-bringup/phase010-usb-storage-flush-capability/phase.md); it does not
