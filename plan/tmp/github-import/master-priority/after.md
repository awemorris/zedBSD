...
| WS | 内容 | 状態 | 残作業・参照点 |
| --- | --- | --- | --- |
| [WS001](https://github.com/awemorris/zedBSD/issues/2) | POSIX準拠 | 継続 | 準拠性台帳・コード規約の残件。 |
| [WS002](https://github.com/awemorris/zedBSD/issues/3) | システムサービス | 完了 | p021をユーザー判断でcleared。p023/p024完了、POSIXの引継ぎと既知バグの再発条件は保持。 |
| [WS003](https://github.com/awemorris/zedBSD/issues/4) | x86・PC-98実機対応 | 継続 | V13起動、実機SMP時計、NVMeインストール・起動の残件。 |
| [WS004](https://github.com/awemorris/zedBSD/issues/5) | ハードウェア拡張 | 継続 | 主要USB/WLAN経路完了。NVMe実機・転送・ドライバ共通化等の後続項目を保持。 |
| [WS005](https://github.com/awemorris/zedBSD/issues/6) | ネットワーク・WLAN | 完了 | p012まで完了。追加回帰・二台同時実機検証はWS025-p033〜p035で完了。 |
| [WS006](https://github.com/awemorris/zedBSD/issues/7) | 入力・evdev | 完了 | q147。両USB構成の通常ビルドで実Xzed/PTYとUSB-root/HID受け入れ。 |
| [WS007](https://github.com/awemorris/zedBSD/issues/8) | グラフィックス・デスクトップ | 一部未クリア | p004の正確なGUI再現条件、amd64残件、統合試験。 |
| [WS008](https://github.com/awemorris/zedBSD/issues/9) | Noct・BeUI | 完了 | q063。 |
| [WS009](https://github.com/awemorris/zedBSD/issues/10) | ドキュメント | 手動保留項目待ち | p001〜p008完了。残るDOC-54はWS014 GPUの保留解除後にPhase化。 |
| [WS010](https://github.com/awemorris/zedBSD/issues/11) | スクリプト・イメージツール | 完了 | q063。 |
| [WS011](https://github.com/awemorris/zedBSD/issues/12) | ネットワーク設定コンソール | 完了（ユーザー確認） | commit confirmed完了。VLANキャンセル、bridgeはF-001へ移管。 |
| [WS012](https://github.com/awemorris/zedBSD/issues/13) | サービス管理コンソール | 完了 | q018。 |
| [WS014](https://github.com/awemorris/zedBSD/issues/15) | ネイティブGPU | 明示保留 | GPU設計の保留解除時に再開。 |
| [WS016](https://github.com/awemorris/zedBSD/issues/17) | 実行時swap制御 | 完了 | q021。 |
| [WS017](https://github.com/awemorris/zedBSD/issues/18) | LFB描画高速化 | 依存待ち | WS022後にmmap・Xzed高速描画・受け入れ。 |
| [WS018](https://github.com/awemorris/zedBSD/issues/19) | カーネル所有権・構成統一 | 完了 | p001〜p020。I/O後続はWS025。 |
| [WS019](https://github.com/awemorris/zedBSD/issues/20) | インストール・ディスク管理 | Priority 4 | 完了（q186）。amd64共存・専用・グラフィカル版とPC98 FATインストールを受け入れ済み。 |
| [WS020](https://github.com/awemorris/zedBSD/issues/21) | Intel Mac UEFI・Variant | 完了 | 2026-09-05ユーザー実機確認。 |
| [WS021](https://github.com/awemorris/zedBSD/issues/22) | LLVM・sysroot | 完了 | q064。 |
| [WS022](https://github.com/awemorris/zedBSD/issues/23) | ELF TLS | 完了 | q128：p001〜p003、両x86 QEMU・dynamic回帰、PC98確認。 |
| [WS023](https://github.com/awemorris/zedBSD/issues/24) | x86 HALコーディング規約 | 完了 | q067。 |
| [WS024](https://github.com/awemorris/zedBSD/issues/25) | 単一64-bit UFS | 完了 | q102。 |
| [WS025](https://github.com/awemorris/zedBSD/issues/26) | I/O・キャッシュ・物理メモリ | 未完了 | p028キャンセル。p029修正後確認待ち、p030実装確認済み/比較残、p032未着手。p023/p037の旧vmap構成は現行修正で撤去・置換。p038確認残。現行状態（ローカル資料: `ws025/post-rollback-review.md`）。 |
| [WS026](https://github.com/awemorris/zedBSD/issues/27) | テスト資産の整理 | 計画のみ | 不要・重複テストの整理と現行ソースへの追随。Phase未詳細化・Queue未投入。 |
