<!-- awesome-plan project=zedbsd record=ws008-p005 -->

既存計画の取り込み。本文はローカルの現行記録、リポジトリ資料へのリンクは基準コミットの履歴です。Issue作成・open状態は実行承認や未完了判定を意味しません。Awesome Planの状態同期導入前のため、実際の状態は本文を参照してください。

元資料: `plan/ws008/phase005/phase.md`

親: [ws008](https://github.com/awemorris/zedBSD/issues/9)
...
Parent: [WS008](https://github.com/awemorris/zedBSD/issues/9)

Tests: [WS008 test index](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws008-noct/tests/README.md)
...
- `NOCT-T040` and `NOCT-T043` passed at
  `plan/ws008/temp/q023-p005-backends.P8ZsxV`. Canonical zedBSD
...
- `NOCT-T044` passed through the complete BeUI QEMU acceptance at
  `plan/ws008/temp/q020-p002-beui.unH7qL`. Drawing, evdev keyboard and
...
- The pinned revision also passed the non-JIT QEMU smoke at
  `plan/ws008/temp/q019-p001-noct.Q5DH4P`, the JIT/RW-to-RX QEMU corpus at
  `plan/ws008/temp/q020-p003-jit.0mYri3`, and the updated p004 host
  regression at `plan/ws008/temp/q022-p004-review.KBH0on`.
