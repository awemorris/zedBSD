<!-- awesome-plan project=zedbsd record=ws025-p029 -->

既存計画の取り込み。本文はローカルの現行記録、リポジトリ資料へのリンクは基準コミットの履歴です。Issue作成・open状態は実行承認や未完了判定を意味しません。Awesome Planの状態同期導入前のため、実際の状態は本文を参照してください。

元資料: `plan/ws025/phase029/phase.md`

親: [ws025](https://github.com/awemorris/zedBSD/issues/26)

# ws025-p029: 条件付き UAS driver

Status: uncleared / 修正後確認待ち（67b28ce0）。旧q230受け入れは履歴として保持。

## 2026-09-10 修正後の扱い

UAS関連とDMA/scratchの修正後確認が必要。現行commitのQEMU受け入れは未実施。実機不要というユーザー基準を維持。
現行ソース照合（ローカル資料: `../post-rollback-review.md`）。以下の旧計画より本項を優先する。
...
[最終結果と受け入れ監査](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws025-io-memory-cache/phase029-uas/results.md#q230--retained-dirty-acceptance-and-p029-completion-2026-09-10)を参照。
...
Result and next implementation: [captured capabilities and transport design](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws025-io-memory-cache/phase029-uas/transport-design.md).
...
追加の先行条件: [ws025-p031](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws025-io-memory-cache/phase031-driver-layout-style/phase.md) のドライバ整理を完了してから実装する。下記の旧ソースパスは p031 の移行表で解決する。既存の採用条件は維持する。

追加の回帰 gate: [ws025-p032](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws025-io-memory-cache/phase032-pc98-boot-regression/phase.md) の PC-98 QEMU 起動回復を完了してから実装へ進む。
...
See [effective policy and evidence basis](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws025-io-memory-cache/phase026-integration-defaults/effective-policy.md).
...
Stream実装の接続箇所と所有権: [stream integration](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws025-io-memory-cache/phase029-uas/stream-integration.md).
