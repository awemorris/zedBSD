...
- Primary Milestone: **MG004 — データを保持しメモリ/ストレージを実用的に使える**
- Related Milestones: MG003, MG008
- Objectives: O1, O2, O4
- 貢献する成果: メモリ・キャッシュ・I/O・媒体回復の整合と実用性を整える。
...
p029はMG004、p030はMG004/MG005、p032はMG003/MG008、p038はMG008/MG001への直接貢献として扱う。p028はcanceledであり、達成証拠に数えない。
