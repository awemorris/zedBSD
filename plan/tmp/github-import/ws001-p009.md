<!-- awesome-plan project=zedbsd record=ws001-p009 -->

既存計画の取り込み。本文はローカルの現行記録、リポジトリ資料へのリンクは基準コミットの履歴です。Issue作成・open状態は実行承認や未完了判定を意味しません。Awesome Planの状態同期導入前のため、実際の状態は本文を参照してください。

元資料: `plan/ws001/phase009/phase.md`

親: [ws001](https://github.com/awemorris/zedBSD/issues/2)

# ws001-p009: POSIX.1-2024 utility compatibility audit

WSID: `ws001`

Phase ID: `p009`

Status: complete as audit; findings remain active in the WS ledger
...
[WS001](https://github.com/awemorris/zedBSD/issues/2). Future work
...
The audit Phase is complete and was not interrupted. Its findings intentionally
remain open in [WS001](https://github.com/awemorris/zedBSD/issues/2). Resume any one finding by extracting a new
bounded Phase; do not rewrite this audit's historical promotion count.

## Completion conditions

- Every utility in the selected audit inventory has been inspected against the checklist.
- External-source conflicts and semantic incompatibilities are listed with evidence.
- The WS001 ledger and utility matrix contain every handoff found by the audit.
- Audit validation commands recorded above pass without promoting unsupported behavior.
