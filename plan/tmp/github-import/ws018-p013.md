<!-- awesome-plan project=zedbsd record=ws018-p013 -->

既存計画の取り込み。本文はローカルの現行記録、リポジトリ資料へのリンクは基準コミットの履歴です。Issue作成・open状態は実行承認や未完了判定を意味しません。Awesome Planの状態同期導入前のため、実際の状態は本文を参照してください。

元資料: `plan/ws018/phase013/phase.md`
...
Parent: [WS018](https://github.com/awemorris/zedBSD/issues/19)

Tests: [WS018 test index](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws018-kernel-architecture/tests/README.md)
...
authorizes Queue selection and execution through [q077](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/queue-q077.md).
...
| [mount_rootfs / mount_root_inode](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/src/kern/mount.c) and declarations | No current callers in the searched maintained tree. Former synthetic-root creation and bare-inode boot-root accessors; remove both. Keep `mount_root_create` and `mount_root_get_ref`. |
| [m_mountpoint](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/include/kern/mount.h), `mount_follow`, `mount_cross_parent` | No assignment to the field remains. Both old inode-only traversal functions have no callers and only inspect this unset field. Delete field, implementations and declarations. |
| [INODE_MOUNTPOINT](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/include/kern/inode.h) | Its only producer is uncalled `rootfs_add_mountpoint`. Remaining reads are that dead rootfs removal function and four unlink/rmdir/rename masks in [inode.c](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/src/kern/inode.c). Remove this obsolete bit and its mask terms after the zero-producer check; preserve all other protections. Do not renumber remaining flag values. |
...
- Build amd64 and i386 PC/AT and PC-98 using `make -j16`, with maintained
  `plan/ws021/tests/config-pcat.mk` / `config-pc98.mk` for the
...
Historical checkpoint: [2026-09-05 resume preparation](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws018-kernel-architecture/phase013-legacy-disk-mount-residue/resume.md), including
...
completion. The user explicitly authorized [p014](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws018-kernel-architecture/phase014-mounted-namespace-protection/phase.md)
...
Completed in q077. [Findings and coverage](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws018-kernel-architecture/tests/q077-filesystem-audit.md)
and [exact results](https://github.com/awemorris/zedBSD/blob/67b28ce04445787ad9225be4a703e3323587b6f1/plan/ws018-kernel-architecture/tests/q077-results.md) retain the original failures and
