<!-- awesome-plan project=zedbsd record=ws008-p001 -->

既存計画の取り込み。本文はローカルの現行記録、リポジトリ資料へのリンクは基準コミットの履歴です。Issue作成・open状態は実行承認や未完了判定を意味しません。Awesome Planの状態同期導入前のため、実際の状態は本文を参照してください。

元資料: `plan/ws008/phase001/phase.md`
...
- [x] Add focused preset/artifact checks under `plan/ws008/tests/`.
...
- `NOCT-T001` and `NOCT-T002`: PASS in
  `plan/ws008/temp/p001-host-20260827T185736Z-2/`. Both root-error cases,
...
- `NOCT-T003`: PASS in
  `plan/ws008/temp/q019-p001-noct.eqwMMU/`. The amd64/PC-AT image boots to
