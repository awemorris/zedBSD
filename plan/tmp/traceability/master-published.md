...
| Goal | 当面の成果 | 対応Milestone | 既存Phase |
| --- | --- | --- | --- |
| fg001 | 修正後の現行構成を確認し、実装と記録を一致させる | MG001 / MG004 / MG008 | [ws025-p029](https://github.com/awemorris/zedBSD/issues/352), [ws025-p038](https://github.com/awemorris/zedBSD/issues/361) |
| fg002 | PC-9821V13のCF/IDE起動問題を解決する | MG003 / MG008 | [ws025-p032](https://github.com/awemorris/zedBSD/issues/355) |
| fg003 | 現行IMOD設定の根拠と残る検証範囲を確定する | MG004 / MG005 | [ws025-p030](https://github.com/awemorris/zedBSD/issues/353) |

Focusは計画上の対応であり、新規Queueの実行許可ではない。p028はcanceledとして除外し、WS009/DOC-54はWS014の保留に従う。
...
| 順位 | 対象 | 次に行う内容 |
| --- | --- | --- |
| 1 | [WS025](https://github.com/awemorris/zedBSD/issues/26) | 67b28ce0修正後：p027完了、p028キャンセル、p029修正後確認待ち、p030現行IMOD実装確認済み（動作・比較確認残）、p032未着手。HAL名称統一は保持、旧vmap移設案は撤回、p038固定入口は現行APIでの確認残。修正後照合（ローカル資料: `ws025/post-rollback-review.md`）。 |
| 2 | [WS006](https://github.com/awemorris/zedBSD/issues/7) | 完了（q147）。旧consoleイベントUAPI撤去、paired USB修正とXzed/Noct/BeUI受け入れ。 |
| 3 | [WS022](https://github.com/awemorris/zedBSD/issues/23) | 完了（q128）。ELF TLS/TCB、exec、pthread、両x86受け入れ。 |
| 4 | [WS019](https://github.com/awemorris/zedBSD/issues/20) | 共存経路p004/p005、元選択p027・属P性付きコピーp028・GPT処理p030完了。p006/p049で両モードの実インストールを受け入れ済み。p007のUFSスワップ負荷・断片化も受け入れ済み。p029も完了。追加p050のPC98グラフィカルFATインストールとターゲット単独ログインもq186で完了。 |
| 5 | [WS002](https://github.com/awemorris/zedBSD/issues/3) | 完了。p021は現行試験合格とユーザー判断でcleared。過去の未再現事象はBUG-012に保持。 |
| 6 | [WS009](https://github.com/awemorris/zedBSD/issues/10) | p008をq190で完了し、現行実装の文書整備完了。DOC-54のみWS014の手動保留に依存し、WSは未完了のまま保持。実行可能Phaseなし。 |

p027〜p030のq122での見送りは過去の実績として保持する。
追加必須項目（2026-09-09ユーザー指示）：[WS004-p050](https://github.com/awemorris/zedBSD/issues/141)
はq187で完了。NVMeの1コントローラ制限を解除し、両列挙順の起動、
独立・同時I/O、永続化、検出失敗の分離を検証済み。
WS019は現行テキスト画面で完成を先行し、続いて[p029](https://github.com/awemorris/zedBSD/issues/271)
...
| --- | --- | --- | --- | --- |
| [WS001](https://github.com/awemorris/zedBSD/issues/2) | MG002 | POSIX準拠 | 継続 | 準拠性台帳・コード規約の残件。 |
| [WS002](https://github.com/awemorris/zedBSD/issues/3) | MG005 | システムサービス | 完了 | p021をユーザー判断でcleared。p023/p024完了、POSIXの引継ぎと既知バグの再発条件は保持。 |
| [WS003](https://github.com/awemorris/zedBSD/issues/4) | MG003 | x86・PC-98実機対応 | 継続 | V13起動、実機SMP時計、NVMeインストール・起動の残件。 |
| [WS004](https://github.com/awemorris/zedBSD/issues/5) | MG003 | ハードウェア拡張 | 継続 | 主要USB/WLAN経路完了。NVMe実機・転送・ドライバ共通化等の後続項目を保持。 |
| [WS005](https://github.com/awemorris/zedBSD/issues/6) | MG005 | ネットワーク・WLAN | 完了 | p012まで完了。追加回帰・二台同時実機検証はWS025-p033〜p035で完了。 |
| [WS006](https://github.com/awemorris/zedBSD/issues/7) | MG006 | 入力・evdev | 完了 | q147。両USB構成の通常ビルドで実Xzed/PTYとUSB-root/HID受け入れ。 |
| [WS007](https://github.com/awemorris/zedBSD/issues/8) | MG006 | グラフィックス・デスクトップ | 一部未クリア | p004の正確なGUI再現条件、amd64残件、統合試験。 |
| [WS008](https://github.com/awemorris/zedBSD/issues/9) | MG006 | Noct・BeUI | 完了 | q063。 |
| [WS009](https://github.com/awemorris/zedBSD/issues/10) | MG001 | ドキュメント | 手動保留項目待ち | p001〜p008完了。残るDOC-54はWS014 GPUの保留解除後にPhase化。 |
| [WS010](https://github.com/awemorris/zedBSD/issues/11) | MG001 | スクリプト・イメージツール | 完了 | q063。 |
| [WS011](https://github.com/awemorris/zedBSD/issues/12) | MG005 | ネットワーク設定コンソール | 完了（ユーザー確認） | commit confirmed完了。VLANキャンセル、bridgeはF-001へ移管。 |
| [WS012](https://github.com/awemorris/zedBSD/issues/13) | MG005 | サービス管理コンソール | 完了 | q018。 |
| [WS014](https://github.com/awemorris/zedBSD/issues/15) | MG006 | ネイティブGPU | 明示保留 | GPU設計の保留解除時に再開。 |
| [WS016](https://github.com/awemorris/zedBSD/issues/17) | MG004 | 実行時swap制御 | 完了 | q021。 |
| [WS017](https://github.com/awemorris/zedBSD/issues/18) | MG006 | LFB描画高速化 | 依存待ち | WS022後にmmap・Xzed高速描画・受け入れ。 |
| [WS018](https://github.com/awemorris/zedBSD/issues/19) | MG008 | カーネル所有権・構成統一 | 完了 | p001〜p020。I/O後続はWS025。 |
| [WS019](https://github.com/awemorris/zedBSD/issues/20) | MG003 | インストール・ディスク管理 | Priority 4 | 完了（q186）。amd64共存・専用・グラフィカル版とPC98 FATインストールを受け入れ済み。 |
| [WS020](https://github.com/awemorris/zedBSD/issues/21) | MG003 | Intel Mac UEFI・Variant | 完了 | 2026-09-05ユーザー実機確認。 |
| [WS021](https://github.com/awemorris/zedBSD/issues/22) | MG001 | LLVM・sysroot | 完了 | q064。 |
| [WS022](https://github.com/awemorris/zedBSD/issues/23) | MG002 | ELF TLS | 完了 | q128：p001〜p003、両x86 QEMU・dynamic回帰、PC98確認。 |
| [WS023](https://github.com/awemorris/zedBSD/issues/24) | MG001 | x86 HALコーディング規約 | 完了 | q067。 |
| [WS024](https://github.com/awemorris/zedBSD/issues/25) | MG004 | 単一64-bit UFS | 完了 | q102。 |
| [WS025](https://github.com/awemorris/zedBSD/issues/26) | MG004 | I/O・キャッシュ・物理メモリ | 未完了 | p028キャンセル。p029修正後確認待ち、p030実装確認済み/比較残、p032未着手。p023/p037の旧vmap構成は現行修正で撤去・置換。p038確認残。現行状態（ローカル資料: `ws025/post-rollback-review.md`）。 |
| [WS026](https://github.com/awemorris/zedBSD/issues/27) | MG001 | テスト資産の整理 | 計画のみ | 不要・重複テストの整理と現行ソースへの追随。Phase未詳細化・Queue未投入。 |
