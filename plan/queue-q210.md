...
| --- | --- | --- | --- |
| 1 | [ws025-p029](ws025-io-memory-cache/phase029-uas/phase.md) | uncleared | Inject one QEMU backend write EIO, prove read success does not erase subsequent write/fsync failure; verify backing invariants |
