...
| --- | --- | --- | --- |
| 1 | [ws025-p021](ws025-io-memory-cache/phase021-ufs-metadata-writeback/phase.md) | uncleared | Integrate recoverable inode reservation, creation/backing publication and mount orphan ownership using q112's verified metadata, xattr and retirement owners. |
