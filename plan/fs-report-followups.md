...
| 13 | q086 regular syscall batching followed by [q087 request-sized allocation](ws018-kernel-architecture/phase020-syscall-request-batching/results.md): up to 256KiB, 64KiB scalar transfer uses one file-layer call; progressive fallback and pipe contract preserved. | Larger/scattered buffers, vector-element coalescing and downstream BIO batching remain separate design work |
