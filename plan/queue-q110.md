...
| --- | --- | --- | --- |
| 1 | [ws025-p018](ws025-io-memory-cache/phase018-data-writeback/phase.md) | completed | Repair synchronous flags in the resolved-open adapter used by overlay; add stacked native regression discovered during p020 identity inspection. |
| 2 | [ws025-p020](ws025-io-memory-cache/phase020-readahead/phase.md) | completed | Add bounded optional sequential prefetch with demand priority and stale-completion rejection. p016/p019 complete; reuse p018 coherent lifecycle. |
