...
ZEDBSD_USER_PROGRAMS := mview wltest zdesktop gpu-share-test gpu-fence-test gpu-admission-test gpu-recovery-test vkdemo venus-frame cat ls dmesg sleep sync kill rm
