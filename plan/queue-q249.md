...
| --- | --- | --- | --- |
| 1 | [ws025-p037](ws025-io-memory-cache/phase037-hal-interface-consolidation/phase.md) | uncleared | Common VM VA/frame/lifetime owner; scratch/DMA/uaccess migration; remove HAL vmap and lookup; focused owner tests and builds |
