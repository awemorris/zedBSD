...
| --- | --- | --- | --- |
| 1 | [ws025-p029](ws025-io-memory-cache/phase029-uas/phase.md) | uncleared | Add explicit no-fail UFS revoked commit suppressing reclaim, and local dirty-inode disposal/counting; focused checks and three builds |
