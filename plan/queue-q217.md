...
| --- | --- | --- | --- |
| 1 | [ws025-p029](ws025-io-memory-cache/phase029-uas/phase.md) | uncleared | Revoke uncertain removable generation, retire old references, checked reset/init once before fresh publication; host failure checks and build |
