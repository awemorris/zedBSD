...
stop_all='ps -A -o pid,comm | awk "\$2 == \"zwl\" || \$2 == \"Xzed\" || \$2 == \"zgears\" || \$2 == \"glxtest\" {print \$1}" | while read p; do kill $p; done; sleep 1'
status=0
...
# 1. zwl, Xzed rootless, zgears; the picture after a few seconds.
