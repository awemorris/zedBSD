...
WS001_P015_SOURCE := \
	plan/ws001/tests/credential-vfs-native.c
WS001_P015_OBJECT := \
	$(BUILD)/user64/plan/ws001/tests/credential-vfs-native.o
...
WS001_P015_OVERLAY_CONFIG := \
	plan/ws001/tests/credential-vfs-overlay.cfg
WS001_P015_NATIVE_CONFIG := \
	plan/ws001/tests/credential-vfs-native.cfg
...
$(eval $(call ZEDBSD_ARCH_UFS_IMAGE_RULE,$(WS001_P015_OVERLAY_UFS),amd64,\
	...
	plan/ws001/tests/credential-vfs-overlay.txt \
	plan/ws001/tests/credential-vfs-lower-marker.txt \
	$(ZEDBSD_CONFIG),\
	$(WS001_P015_COMMON_FILES) \
	--file /etc/ws001-p015-scenario=plan/ws001/tests/credential-vfs-overlay.txt \
	--file /p015-lower-only/marker=plan/ws001/tests/credential-vfs-lower-marker.txt \
	--mode /p015-lower-only=0777))

$(eval $(call ZEDBSD_ARCH_UFS_IMAGE_RULE,$(WS001_P015_NATIVE_ARCH_UFS),amd64,\
	$(AMD64_ARCH_INPUTS) $(WS001_P015_PROGRAM) \
	plan/ws001/tests/credential-vfs-native.txt $(ZEDBSD_CONFIG),\
	$(WS001_P015_COMMON_FILES) \
	--file /etc/ws001-p015-scenario=plan/ws001/tests/credential-vfs-native.txt))

$(eval $(call ZEDBSD_ARCH_UFS_IMAGE_RULE,$(WS001_P015_FAT_UFS),amd64,\
	$(AMD64_ARCH_INPUTS) $(WS001_P015_PROGRAM) \
	plan/ws001/tests/credential-vfs-fat.txt $(ZEDBSD_CONFIG),\
	$(WS001_P015_COMMON_FILES) \
	--file /etc/ws001-p015-scenario=plan/ws001/tests/credential-vfs-fat.txt))
...
$(WS001_P015_UFS_STAMP): \
	plan/ws001/tests/credential-vfs-ufs.txt
	@rm -rf $(WS001_P015_UFS_ROOT)
	@mkdir -p $(WS001_P015_UFS_ROOT)/writable
	@cp plan/ws001/tests/credential-vfs-ufs.txt \
...
$(WS001_P015_FAT_STAMP): plan/ws001/tests/credential-vfs-fat.txt \
	plan/ws001/tests/credential-vfs-fat-unixmode.txt
	@rm -rf $(WS001_P015_FAT_ROOT)
	@mkdir -p $(WS001_P015_FAT_ROOT)/writable
	@cp plan/ws001/tests/credential-vfs-fat.txt \
