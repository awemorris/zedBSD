...
Superseded structurally by the per-Phase documents under `plan/ws001/`.
...
`plan/ws001/history/phase000-010-legacy-plan.md`; the target standard is
...
[`ws001-p009`](../phase009/phase.md). It found no
