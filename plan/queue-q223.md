...
| --- | --- | --- | --- |
| 1 | [ws025-p029](ws025-io-memory-cache/phase029-uas/phase.md) | uncleared | Commit preflighted revoked VM objects, retire dirty credits and registry identity, destroy detached resources outside registry lock; focused actual-source checks/builds |
...
See [results](ws025-io-memory-cache/phase029-uas/results.md#q223--revoked-vm-discard-commit-2026-09-10).
