...
| --- | --- | --- | --- |
| 1 | [ws025-p029](ws025-io-memory-cache/phase029-uas/phase.md) | uncleared | Keep USB/SCSI device attached, eject old backing and insert distinct backing, require fresh publication and readback at both speeds |
