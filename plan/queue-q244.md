...
| --- | --- | --- | --- |
| 1 | [ws025-p028](ws025-io-memory-cache/phase028-direct-user-io/phase.md) | uncleared | READ/PREAD output views behind default-off flag; prefix-safe fallback and counters; syscall stories, native output comparison and three builds |
...
[review](ws025-io-memory-cache/phase028-direct-user-io/hal-vmap-review.md).
