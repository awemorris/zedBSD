...
| --- | --- | --- | --- |
| 1 | [ws025-p029](ws025-io-memory-cache/phase029-uas/phase.md) | uncleared | Trace-proven pending UAS read, physical device removal, caller termination, replug/readback and halt |
