...
| --- | --- | --- | --- |
| 1 | [ws025-p028](ws025-io-memory-cache/phase028-direct-user-io/phase.md) | uncleared | Clock-free link-only HAL operation counters; native input workload; restoration |
