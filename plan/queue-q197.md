...
| --- | --- | --- | --- |
| 1 | [ws025-p029](ws025-io-memory-cache/phase029-uas/phase.md) | uncleared | Add explicitly gated URB stream identity and default-stream reset semantics, test actual USB core, map xHCI stream-ring ownership changes before enabling capability |
