...
| --- | --- | --- | --- |
| 1 | [ws025-p037](ws025-io-memory-cache/phase037-hal-interface-consolidation/phase.md) | uncleared | Current default input-copy baseline, experimental input view, native data/accounting acceptance, restore ordinary build |
