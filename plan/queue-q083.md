...
| --- | --- | --- | --- |
| 1 | [ws004-p046](ws004-hardware/phase046-archer-t3u-plus-driver/phase.md) | completed | Exact SuperSpeed device passes three complete cycles on both bands and final fresh reopen/down; bounded disconnect EBUSY handling and all focused/build gates pass |
...
See [q083 results](ws004-hardware/tests/q083-results.md) for hashes, observations
