...
| --- | --- | --- | --- |
| 1 | [ws025-p028](ws025-io-memory-cache/phase028-direct-user-io/phase.md) | uncleared | Nonblocking upgrade from caller-owned private pins to BUSY ownership, controlled concurrent fixture and supported builds |
