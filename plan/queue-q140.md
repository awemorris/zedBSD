...
| --- | --- | --- | --- |
| 1 | [ws002-p024](ws002-services/phase024-retirement-heap-integrity/phase.md) | uncleared | Daybreak implements bounded private free-list/walk diagnostics, focused tests, at most two original paired traced replays and one optional churn replay; correct only a proved cause |
