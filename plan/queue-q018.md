...
| 4 | `ws012-p006` | [WS012](ws012-service-console/ws.md), [Phase](ws012-service-console/phase006-integration-acceptance/phase.md), [tests](ws012-service-console/tests/README.md) | completed | Focused fixtures, production amd64 QEMU behavior, persistence/failure/concurrency cases, fatal-log scan, and public documentation prove the complete WS012 contract |
...
[p006 result matrix](ws012-service-console/tests/q018-p006-results.tsv) and
[integration record](ws012-service-console/tests/q018-p006-qemu-evidence.md).
...
[`ws001-p014`](ws001-posix/phase014-shell-job-control/phase.md). Formatting,
