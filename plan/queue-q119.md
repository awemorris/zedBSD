...
| --- | --- | --- | --- |
| 1 | [ws025-p023](ws025-io-memory-cache/phase023-kernel-vmap/phase.md) | completed | Bounded VA reservation, owned noncontiguous pages, shared upper-half PTE publication/rollback/shootdown, pinned lifetime and generic kernel page lookup. Integrate optional pool/worker backing only after owner verification. Depends on p005/p016. |
