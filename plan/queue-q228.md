...
| --- | --- | --- | --- |
| 1 | [ws025-p029](ws025-io-memory-cache/phase029-uas/phase.md) | uncleared | Integrate closed mount admission/preflight/commit, expose umount -f through root-only syscall, build and run mounted-medium QEMU acceptance |
