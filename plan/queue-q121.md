...
| --- | --- | --- | --- |
| 1 | [ws025-p025](ws025-io-memory-cache/phase025-storage-media-recovery/phase.md) | completed | Join bounded SCSI recovery and media identity with common disk/cache admission, independent retirement, and checked shutdown. Depends on completed p001/p014 and preserves p024 staging ownership. |

Follow [recovery design](ws025-io-memory-cache/phase025-storage-media-recovery/recovery-design.md).
...
Result: p025 completed; [evidence](ws025-io-memory-cache/phase025-storage-media-recovery/results.md). All runs terminal, ordinary artifact restored. Continue with p026.
