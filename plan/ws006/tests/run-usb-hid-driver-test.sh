...
hotplug_fixture="$repo/plan/ws006/tests/xhci-hid-hot-unplug-test.c"
...
cc $common -O2 -Wl,--gc-sections \
	"$repo/plan/ws006/tests/usb-hid-driver-test.c" \
	 -o "$ordinary"
"$ordinary"
...
grep -Fq 'USB_DEVICE_LIFECYCLE_DISCONNECTING |' "$repo/src/drivers/usb/usb.c"
