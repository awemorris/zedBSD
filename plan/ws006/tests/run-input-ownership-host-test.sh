...
console_sources="$repo/plan/ws006/tests/console-input-ownership-test.c $repo/src/drivers/generic/console.c $repo/src/drivers/generic/input.c $repo/plan/ws006/tests/input-host-unreachable.c"
...
resync_test="$repo/plan/ws006/tests/hal-input-resync-test.c"
...
cc $common "$repo/plan/ws006/tests/x68k-keyboard-ownership-test.c" \
	"$repo/src/hal/m68k/bsp-x68k/keyboard-map.c" \
	"$repo/src/drivers/generic/input.c" "$repo/plan/ws006/tests/input-host-unreachable.c" \
	-o "$temporary/x68k"
"$temporary/x68k"
cc $common -g -fno-omit-frame-pointer -fsanitize=address,undefined \
	"$repo/plan/ws006/tests/x68k-keyboard-ownership-test.c" \
	"$repo/src/hal/m68k/bsp-x68k/keyboard-map.c" \
	"$repo/src/drivers/generic/input.c" "$repo/plan/ws006/tests/input-host-unreachable.c" \
...
pc98_sources="$repo/plan/ws006/tests/pc98-keyboard-ownership-test.c $repo/src/hal/i386/bsp-pc98/cons.c $repo/src/drivers/generic/input.c $repo/plan/ws006/tests/input-host-unreachable.c"
