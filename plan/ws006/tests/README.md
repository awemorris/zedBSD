...
```sh
sh plan/ws006/tests/run-input-ownership-host-test.sh
```
...
`plan/ws006/tests/hid-report-test.c`; its strict, ASan/UBSan, and GCC
...
cc -m64 -nostdinc -Ilibc/include -Iinclude/uapi -Iinclude \
  ...
  plan/ws006/tests/evdev-layout-test.c
...
cc -std=c11 -D_POSIX_C_SOURCE=200809L -Iinclude/uapi -Iinclude \
  ...
  plan/ws006/tests/input-queue-test.c -o /tmp/ws006-input-queue
...
cc -std=c11 -D_POSIX_C_SOURCE=200809L -Iinclude/uapi -Iinclude \
  ...
  plan/ws006/tests/input-capability-test.c \
...
cc -std=c11 -DHAL_ARCH_AMD64 -Iinclude/uapi -Iinclude -Wall -Wextra \
  ...
  plan/ws006/tests/input-keymap-test.c -o /tmp/ws006-input-keymap
...
```sh
plan/ws006/tests/qemu-evdev-capability.sh
```
...
```sh
plan/ws006/tests/qemu-usb-hid-acceptance.sh \
