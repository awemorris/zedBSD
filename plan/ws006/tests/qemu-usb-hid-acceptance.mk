...
WS006_P008_PROBE_SOURCE := \
	plan/ws006/tests/usb-hid-guest-probe.c
WS006_P008_PROBE_OBJECT := \
	$(BUILD)/user64/plan/ws006/tests/usb-hid-guest-probe.o
...
$(WS025_IMOD_OBJECT): plan/ws025/tests/imod-storage-guest.c
	@mkdir -p $(dir $@)
...
$(WS006_P008_IMAGE): $(BUILD)/bootloader/stage1.bin \
	...
	$(NOCT) --path=tools/build tools/build/make-bios-hdd-image.noct \
		...
		--machine pcat --layout $(ZEDBSD_VARIANT) \
