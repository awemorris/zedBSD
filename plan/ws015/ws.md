...
- [WS001](../ws001/ws.md) owns the ordinary POSIX boundary and records
  any interaction or incompatibility debt; RT APIs remain a distinct profile.
- [WS003](../ws003/ws.md) and
  [WS004](../ws004/ws.md) provide CPU topology, SMP startup, local
  timers, interrupt routing, MSI, reset/watchdog, and target-board evidence.
- [WS009](../ws009/ws.md) publishes the final API, restrictions,
...
| --- | --- | --- | --- |
| `ws015-p001` | [Architecture and compatibility discussion](phase001/phase.md) | Future List F-003 | Freeze the μITRON profile, RT/POSIX partition, resident-execution contract, failure boundary, timing target, and later Phase map |
