...
| --- | --- | --- | --- |
| 1 | [ws025-p029](ws025-io-memory-cache/phase029-uas/phase.md) | uncleared | Check every revoked-medium buffer before destructive discard under existing external-user exclusion; preserve dirty buffers on busy refusal |
