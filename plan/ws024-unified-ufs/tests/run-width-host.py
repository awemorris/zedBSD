...
for arch,abi in [('amd64',['-m64','-DZEDBSD_USER_ABI_LP64']),('i386',['-m32'])]:
 binary=str(out/arch)
 args=['cc',*abi,'-std=c11','-O1','-Wall','-Wextra','-Werror','-ffreestanding','-fno-builtin','-fno-stack-protector','-fno-pie','-no-pie','-ffunction-sections','-fdata-sections','-nostdlib','-static','-I.','-Iinclude','-Iinclude/uapi','-Isrc','-Ilibc/include','plan/ws024-unified-ufs/tests/ufs-width-host.c','plan/ws025-io-memory-cache/temp/p031-driver-fragments/src/drivers/fs/ufs/ufs-endian.c','-Wl,--gc-sections,-e,_start','-o',binary]
