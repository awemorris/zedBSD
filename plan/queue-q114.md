...
| --- | --- | --- | --- |
| 1 | [ws025-p021](ws025-io-memory-cache/phase021-ufs-metadata-writeback/phase.md) | uncleared | Add immutable pending-image read pins and integrate coherent metadata readers around checkpoint I/O, using q111–q113 verified transaction/creation/orphan ownership. |
