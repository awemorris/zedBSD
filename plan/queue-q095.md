...
| --- | --- | --- | --- |
| 1 | [ws025-p008](ws025-io-memory-cache/phase008-ufs-data-runs/phase.md) | completed | Coalesce existing contiguous UFS data blocks up to 64 KiB and retain FAT/loop extents. Requires completed p007. |
