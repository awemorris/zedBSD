...
static const struct sh_builtin builtins[] = {
	...
	{ "let", sh_builtin_let, 0 },
	{ "local", sh_builtin_local,
	  SH_BUILTIN_SPECIAL | SH_BUILTIN_DECLARATION },
	{ "popd", sh_builtin_popd, 0 },
	{ "printf", sh_builtin_printf, 0 },
	{ "pushd", sh_builtin_pushd, 0 },
	...
	{ "source", sh_builtin_dot, SH_BUILTIN_SPECIAL },
	...
	{ "typeset", sh_builtin_declare, SH_BUILTIN_DECLARATION },
