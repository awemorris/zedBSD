...
#ifndef KERN_BOOT_PARAMETER_HANDOFF_H
#define KERN_BOOT_PARAMETER_HANDOFF_H

#include "parameters.h"

#define KERN_BOOT_PARAMETER_RECORD_MAGIC 0x31525042 /* "BPR1" */
...
#define KERN_BOOT_PARAMETER_RECORD_SIZE \
	(KERN_BOOT_PARAMETER_RECORD_HEADER_SIZE + \
	 KERN_BOOT_PARAMETERS_STORAGE_SIZE)
...
_Static_assert(sizeof(struct kern_boot_parameter_record) ==
