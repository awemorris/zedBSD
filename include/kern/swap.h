...
void swap_init(struct swap_backend *);
int swap_activate(struct swap_backend *, const struct swap_backend_ops *,
		  void *, uint32_t, uint32_t);
int swap_alloc_slot(struct swap_backend *, uint32_t *);
void swap_free_slot(struct swap_backend *, uint32_t);
int swap_read_page(struct swap_backend *, uint32_t, void *);
int swap_write_page(struct swap_backend *, uint32_t, const void *);
int swap_flush(struct swap_backend *);
int swap_shutdown(struct swap_backend *);
