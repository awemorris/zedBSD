...
struct net_device_ops {
	...
	int (*ioctl)(struct net_device *device, unsigned long request, void *argument);
};
...
struct net_device *net_device_find_by_index(unsigned ifindex);
struct net_device *net_device_at(unsigned index);
