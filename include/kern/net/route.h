...
int route_lookup_ref(uint32_t destination, struct net_route *result);
int route_get_ref(unsigned ordinal, struct net_route *result);
void route_release(struct net_route *route);
