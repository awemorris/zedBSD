...
struct filedesc *filedesc_create(struct process *);
...
int filedesc_clone(struct filedesc *, struct process *, struct filedesc **);
...
int filedesc_install_many(struct filedesc *, struct file **, unsigned,
			  unsigned, int *);
int filedesc_reserve_many(struct filedesc *, unsigned, unsigned,
			  struct filedesc_reservation *);
int filedesc_commit_reserved(struct filedesc_reservation *, struct file **,
			     int *);
void filedesc_abort_reserved(struct filedesc_reservation *);
int filedesc_set_limit(struct filedesc *, unsigned);
unsigned filedesc_get_limit(struct filedesc *);
