...
/*
 * locale_t comes before the includes: <stdio.h>, <wchar.h> and <time.h> take
 * it from here, and a replacement <stdint.h> (gnulib's) can lead back to them
 * through <inttypes.h> while this header is still being read.
 */
struct __locale;
